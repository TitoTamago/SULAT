    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                        ...
                        <div class="card h-100 mb-0">
                            <div class="card-body p-0">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="card-body chat-user-list pt-0" data-simplebar>
                    ...
                    <div class="card h-100 overflow-hidden mb-0">
                        <div class="card-header border-bottom border-dashed">
                            <div class="d-flex align-items-center gap-2">
                                <a href="javascript: void(0);" class="btn btn-light px-1 d-xxl-none d-inline-flex" data-bs-toggle="offcanvas" data-bs-target="#emailSidebaroffcanvas"
                                    aria-controls="emailSidebaroffcanvas">
                                    <i data-lucide="menu" class="font-18"></i>
                                </a>
                                ...
                                <div class="d-flex gap-3">
                                    <div class="d-none d-lg-inline-flex gap-3">
                                        <a href="javascript: void(0);" class="text-body font-18 d-inline-flex" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Voice Call"
                                            data-bs-original-title="Voice Call">
                                            <i data-lucide="phone-call"></i>
                                        </a>

                                        <a href="javascript: void(0);" class="text-body font-18 d-inline-flex" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Video Call"
                                            data-bs-original-title="Video Call">
                                            <i data-lucide="video"></i>
                                        </a>

                                        <a href="javascript: void(0);" class="text-body font-18 d-inline-flex" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Add Users"
                                            data-bs-original-title="Add Users">
                                            <i data-lucide="user-plus"></i>
                                        </a>

                                        <a href="javascript: void(0);" class="text-body font-18 d-inline-flex" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Delete Chat"
                                            data-bs-original-title="Delete Chat">
                                            <i data-lucide="trash-2"></i>
                                        </a>
                                    </div>

                                    <a href="javascript: void(0);" class="text-body font-18 d-xxl-none d-inline-flex" data-bs-toggle="offcanvas" data-bs-target="#userInfoOffcanvas"
                        ...
                        <div class="card-body bg-light mt-2">
                            <form class="needs-validation" novalidate="" name="chat-form" id="chat-form">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="btn-group">
                                        <a href="#" class="btn btn-light d-none d-md-inline-block"><i class="uil uil-paperclip"></i></a>
                                        <a href="#" class="btn btn-light d-none d-md-inline-block"> <i class='uil uil-smile'></i> </a>
                ...
                <!-- start user detail -->
                <div class="col-xxl-3">
                    <div class="offcanvas-xxl offcanvas-end h-100 file-offcanvas" tabindex="-1" id="userInfoOffcanvas" aria-labelledby="userInfoOffcanvasLabel">
                        <div class="card chat-user-info mb-0" data-simplebar>
                            <div class="card-body">

                                <div>
                                    <div class="float-start d-xxl-none d-inline-block">
                                        <button type="button" class="btn-close" data-bs-dismiss="offcanvas" data-bs-target="#userInfoOffcanvas" aria-label="Close"></button>
                                    </div>
