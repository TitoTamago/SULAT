        ...
        (r.prototype.initCharts = function () {
            ...
            return (
                0 < d("#line-chart-example").length &&
                    ((r = {
                        ...
                        datasets: [
                            {
                                label: "Current Week",
                                backgroundColor: hexToRGB((n = (o = d("#line-chart-example").data("colors")) ? o.split(",") : i.concat())[0], 0.3),
                                fill: !0,
                                borderColor: n[0],
                                data: [32, 42, 42, 62, 52, 75, 62],
                            },
                            { label: "Previous Week", fill: !0, backgroundColor: "transparent", borderColor: n[1], borderDash: [5, 5], data: [42, 58, 66, 93, 82, 105, 92] },
                        ],
                    }),
                    l.push(
                        this.respChart(d("#line-chart-example"), "Line", r, {
                            ...
                            plugins: {
                                ...
                                hover: { enabled: !0, intersect: !0, mode: "nearest" },
                            },
                            tension: 0.3,
                            scales: {
                                x: { grid: { color: "rgba(0,0,0,0.05)" } },
                                y: { ticks: { stepSize: 20 }, display: !0, borderDash: [5, 5], grid: { color: "rgba(0,0,0,0)", fontColor: "#fff" } },
                            },
                        })
                    )),
                0 < d("#bar-chart-example").length &&
                    ((n = (o = d("#bar-chart-example").data("colors")) ? o.split(",") : i.concat()),
                    (t = document.getElementById("bar-chart-example").getContext("2d").createLinearGradient(0, 500, 0, 150)).addColorStop(0, n[0]),
                    t.addColorStop(1, n[1]),
                    (a = {
                        labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
                        datasets: [
                            { label: "Sales Analytics", backgroundColor: t, borderColor: t, hoverBackgroundColor: t, hoverBorderColor: t, data: [65, 59, 80, 81, 56, 89, 40, 32, 65, 59, 80, 81] },
                            {
                                label: "Dollar Rate",
                    ...
                    l.push(
                        this.respChart(d("#bar-chart-example"), "Bar", a, {
                            ...
                            scales: {
                                y: { grid: { display: !1, color: "rgba(0,0,0,0.05)", offset: !0 }, stacked: !1, ticks: { stepSize: 20 } },
                                x: { dataset: {}, stacked: !1, grid: { color: "rgba(0,0,0,0.01)" } },
                            },
                        })
                    )),
                0 < d("#donut-chart-example").length &&
                    ...
                    l.push(this.respChart(d("#donut-chart-example"), "Doughnut", e, { maintainAspectRatio: !1, cutoutPercentage: 60, plugins: { legend: { display: !1 } } }))),
                0 < d("#radar-chart-example").length &&
                    ((s = {
                        ...
                        datasets: [
                            {
                                label: "Desktops",
                                backgroundColor: hexToRGB((n = (o = d("#radar-chart-example").data("colors")) ? o.split(",") : i.concat())[0], 0.2),
                                borderColor: n[0],
                    ...
                    l.push(this.respChart(d("#radar-chart-example"), "Radar", s, { maintainAspectRatio: !1 }))),
                l
            );
        }),
