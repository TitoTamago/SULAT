!(function (r) {
    ...
    (t.prototype.generateData = function () {
        for (var t = [], a = 0; a < 100; a++) t.push(5e3 + 1e5 * Math.random() + 0.8 * a * a * a);
        return t;
    }),
        (t.prototype.init = function () {
            ...
            for (var t = 0; t < 100; t++) {
                var a = new Date();
                this.dayBalanceData.push([a.setDate(a.getDate() + t - 100), this.dayDummyData[t]]);
            }
            this.weekBalanceData = [];
            for (t = 0; t < 100; t++) {
                a = new Date();
                this.weekBalanceData.push([a.setDate(a.getDate() + 7 * t - 700), this.weekDummyData[t]]);
            }
            this.monthBalanceData = [];
            for (t = 0; t < 100; t++) {
                a = new Date();
                this.monthBalanceData.push([a.setDate(a.getDate() + 30 * t - 3e3), this.monthDummyData[t]]);
            }
            this.yearBalanceData = [];
            for (t = 0; t < 100; t++) {
                a = new Date();
                this.yearBalanceData.push([a.setDate(a.getDate() + 365 * t - 36500), this.yearDummyData[t]]);
            }
        ...
        (t.prototype.initDayBalance = function () {
            var t = ["#6c757d"],
                a = r("#day-balance-chart").data("colors");
            a && (t = a.split(","));
            var e = {
        ...
        (t.prototype.initWeekBalance = function () {
            var t = ["#6c757d"],
                a = r("#week-balance-chart").data("colors");
            a && (t = a.split(","));
            var e = {
                chart: { type: "area", height: 350, toolbar: { show: !1 } },
                colors: t,
        ...
        (t.prototype.initMonthBalance = function () {
            var t = ["#6c757d"],
                a = r("#month-balance-chart").data("colors");
            a && (t = a.split(","));
            var e = {
                chart: { type: "area", height: 350, toolbar: { show: !1 } },
                colors: t,
        ...
        (t.prototype.initYearBalance = function () {
            var t = ["#6c757d"],
                a = r("#year-balance-chart").data("colors");
            a && (t = a.split(","));
            var e = {
                chart: { type: "area", height: 350, toolbar: { show: !1 } },
                colors: t,
        ...
        (r.DashboardWallet = new t()),
        (r.DashboardWallet.Constructor = t),
        r.DashboardWallet.init();
})(window.jQuery);
