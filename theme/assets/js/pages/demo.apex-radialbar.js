...
var options = { chart: { height: 320, type: "radialBar" }, plotOptions: { radialBar: { hollow: { size: "70%" } } }, colors: colors, series: [70], labels: ["CRICKET"] },
    chart = new ApexCharts(document.querySelector("#basic-radialbar"), options);
chart.render();
colors = ["#6c757d", "#ffbc00", "#727cf5", "#0acf97"];
(dataColors = $("#multiple-radialbar").data("colors")) && (colors = dataColors.split(","));
options = {
...
(dataColors = $("#circle-angle-radial").data("colors")) && (colors = dataColors.split(","));
options = {
...
options = {
    ...
    fill: { type: "image", image: { src: ["../theme/assets/images/small/small-2.jpg"] } },
...
colors = ["#727cf5"];
(dataColors = $("#stroked-guage-radial").data("colors")) && (colors = dataColors.split(","));
options = {
    chart: { height: 380, type: "radialBar" },
    plotOptions: {
        radialBar: {
...
(dataColors = $("#gradient-chart").data("colors")) && (colors = dataColors.split(","));
options = {
    ...
    plotOptions: {
        radialBar: {
            ...
            track: { background: "#fff", strokeWidth: "67%", margin: 0, dropShadow: { enabled: !0, top: -3, left: 0, blur: 4, opacity: 0.35 } },
            dataLabels: {
                showOn: "always",
    ...
    fill: { type: "gradient", gradient: { shade: "dark", type: "horizontal", shadeIntensity: 0.5, gradientToColors: colors, inverseColors: !0, opacityFrom: 1, opacityTo: 1, stops: [0, 100] } },
    series: [75],
    stroke: { lineCap: "round" },
    labels: ["Percent"],
};
