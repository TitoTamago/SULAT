...
(dataColors = $("#multiple-series-heatmap").data("colors")) && (colors = dataColors.split(","));
options = {
    chart: { height: 380, type: "heatmap" },
    dataLabels: { enabled: !1 },
    colors: colors,
...
(dataColors = $("#color-range-heatmap").data("colors")) && (colors = dataColors.split(","));
options = {
    chart: { height: 380, type: "heatmap" },
    plotOptions: {
        heatmap: {
...
(dataColors = $("#rounded-heatmap").data("colors")) && (colors = dataColors.split(","));
options = {
    chart: { height: 380, type: "heatmap" },
    stroke: { width: 0 },
    plotOptions: {
