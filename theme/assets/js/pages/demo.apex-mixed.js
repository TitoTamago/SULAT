...
(dataColors = $("#multiple-yaxis-mixed").data("colors")) && (colors = dataColors.split(","));
options = {
...
(dataColors = $("#line-area-mixed").data("colors")) && (colors = dataColors.split(","));
options = {
    chart: { height: 380, type: "line", toolbar: { show: !1 } },
...
colors = ["#727cf5", "#39afd1", "#fa5c7c"];
(dataColors = $("#all-mixed").data("colors")) && (colors = dataColors.split(","));
options = {
    chart: { height: 380, type: "line", stacked: !1, toolbar: { show: !1 } },
