!(function (i) {
    ...
    (e.prototype.initCharts = function () {
        ...
        r = {
            ...
            fill: {
                type: "gradient",
                gradient: { inverseColors: !0, shade: "light", type: "horizontal", shadeIntensity: 0.25, gradientToColors: void 0, opacityFrom: 1, opacityTo: 1, stops: [0, 100, 100, 100] },
            },
            tooltip: {
                y: {
                    formatter: function (e) {
            ...
            0 < i("#world-map-markers").length &&
                i("#world-map-markers").vectorMap({
                    ...
                    series: {
                        regions: [
                            {
                                values: { KR: "#e6ebff", CA: "#b3c3ff", GB: "#809bfe", NL: "#4d73fe", IT: "#1b4cfe", FR: "#727cf5", JP: "#e7fef7", US: "#e7e9fd", CN: "#8890f7", IN: "#727cf5" },
                                attribute: "fill",
                            },
                        ],
                    },
