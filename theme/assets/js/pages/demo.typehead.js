$(document).ready(function () {
    ...
    e = new Bloodhound({ datumTokenizer: Bloodhound.tokenizers.whitespace, queryTokenizer: Bloodhound.tokenizers.whitespace, local: e });
    ...
    $("#multiple-datasets").typeahead(
        { highlight: !0 },
        { name: "nba-teams", display: "team", source: s, templates: { header: '<h5 class="league-name">NBA Teams</h5>' } },
        { name: "nhl-teams", display: "team", source: i, templates: { header: '<h5 class="league-name">NHL Teams</h5>' } }
    );
});
