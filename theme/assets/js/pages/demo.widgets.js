...
var randomizeArray = function (e) {
    for (var r, t, a = e.slice(), o = a.length; 0 !== o; ) (t = Math.floor(Math.random() * o)), (r = a[--o]), (a[o] = a[t]), (a[t] = r);
    return a;
};
$(document).ready(function () {
    ...
    var a = ["#3688fc"],
        o = $("#sales-spark").data("colors");
    o && (a = o.split(","));
    var s = {
        chart: { type: "area", height: 172, sparkline: { enabled: !0 } },
        ...
        colors: a,
        labels: r,
        title: { text: "$424,652", offsetX: 20, offsetY: 20, style: { fontSize: "24px" } },
        subtitle: { text: "Sales", offsetX: 20, offsetY: 55, style: { fontSize: "14px" } },
    };
    new ApexCharts(document.querySelector("#sales-spark"), s).render();
    a = ["#0acf97"];
    (o = $("#profit-spark").data("colors")) && (a = o.split(","));
    var l = {
        chart: { type: "bar", height: 172, sparkline: { enabled: !0 } },
        ...
        yaxis: { min: 0 },
        colors: a,
        title: { text: "$135,965", offsetX: 20, offsetY: 20, style: { fontSize: "24px" } },
        subtitle: { text: "Profits", offsetX: 20, offsetY: 55, style: { fontSize: "14px" } },
    };
    new ApexCharts(document.querySelector("#profit-spark"), l).render();
    a = ["#734CEA"];
    (o = $("#spark1").data("colors")) && (a = o.split(","));
    var i = {
            chart: { type: "line", height: 100, sparkline: { enabled: !0 } },
        ...
        a = ["#34bfa3"];
    (o = $("#spark2").data("colors")) && (a = o.split(","));
    var n = {
        ...
        a = ["#f4516c"];
    (o = $("#spark3").data("colors")) && (a = o.split(","));
    var c = {
            chart: { type: "line", height: 100, sparkline: { enabled: !0 } },
        ...
        a = ["#00c5dc"];
    (o = $("#spark4").data("colors")) && (a = o.split(","));
    var d = {
        chart: { type: "bar", height: 100, sparkline: { enabled: !0 } },
    ...
    new ApexCharts(document.querySelector("#spark1"), i).render(),
        new ApexCharts(document.querySelector("#spark2"), n).render(),
        new ApexCharts(document.querySelector("#spark3"), c).render(),
