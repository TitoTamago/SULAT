...
options = {
    annotations: { points: [{ x: "Bananas", seriesIndex: 0, label: { borderColor: "#727cf5", offsetY: 0, style: { color: "#fff", background: "#727cf5" }, text: "Bananas are good" } }] },
    chart: { height: 380, type: "bar", toolbar: { show: !1 } },
    ...
    fill: {
        type: "gradient",
        gradient: { shade: "light", type: "horizontal", shadeIntensity: 0.25, gradientToColors: void 0, inverseColors: !0, opacityFrom: 0.85, opacityTo: 0.85, stops: [50, 0, 100] },
    },
};
    ...
    series: [
        {
            name: "Cash Flow",
            data: [
                1.45, 5.42, 5.9, -0.42, -12.6, -18.1, -18.2, -14.16, -11.1, -6.09, 0.34, 3.88, 13.07, 5.8, 2, 7.37, 8.1, 13.57, 15.75, 17.1, 19.8, -27.03, -54.4, -47.2, -43.3, -18.6, -48.6, -41.1,
...
options = {
    ...
    xaxis: { categories: ["John", "Joe", "Jake", "Amber", "Peter", "Mary", "David", "Lily"], labels: { style: { colors: colors, fontSize: "14px" } } },
    legend: { offsetY: 7 },
    grid: { row: { colors: ["transparent", "transparent"], opacity: 0.2 }, borderColor: "#f1f3fa" },
};
