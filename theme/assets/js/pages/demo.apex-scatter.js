...
(dataColors = $("#datetime-scatter").data("colors")) && (colors = dataColors.split(","));
options = {
    ...
    colors: colors,
    grid: { borderColor: "#f1f3fa", padding: { bottom: 5 }, xaxis: { showLines: !0 }, yaxis: { showLines: !0 } },
    legend: { offsetY: 7 },
    xaxis: { type: "datetime" },
    yaxis: { max: 70 },
    responsive: [{ breakpoint: 600, options: { chart: { toolbar: { show: !1 } }, legend: { show: !1 } } }],
...
(chart = new ApexCharts(document.querySelector("#datetime-scatter"), options)).render();
colors = ["#056BF6", "#D2376A"];
(dataColors = $("#scatter-images").data("colors")) && (colors = dataColors.split(","));
options = {
    chart: { height: 380, type: "scatter", animations: { enabled: !1 }, zoom: { enabled: !1 }, toolbar: { show: !1 } },
    colors: colors,
    series: [
        {
            name: "Messenger",
    ...
    yaxis: { tickAmount: 7 },
    markers: { size: 20 },
    fill: { type: "image", opacity: 1, image: { src: ["../theme/assets/images/ico-messenger.png", "../theme/assets/images/ico-instagram.png"], width: 40, height: 40 } },
    legend: {
...
(chart = new ApexCharts(document.querySelector("#scatter-images"), options)).render();
