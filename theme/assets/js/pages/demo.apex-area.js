...
(chart = new ApexCharts(document.querySelector("#spline-area"), options)).render(),
    $(document).ready(function () {
        ...
        var a = {
                annotations: {
                    yaxis: [{ y: 30, borderColor: "#999", label: { show: !0, text: "Support", style: { color: "#fff", background: "#00E396" } } }],
                    xaxis: [{ x: new Date("14 Nov 2012").getTime(), borderColor: "#999", yAxisIndex: 0, label: { show: !0, text: "Rally", style: { color: "#fff", background: "#775DD0" } } }],
                },
        ...
        document.querySelector("#one_month").addEventListener("click", function (e) {
            r(e), o.updateOptions({ xaxis: { min: new Date("28 Jan 2013").getTime(), max: new Date("27 Feb 2013").getTime() } });
        }),
            document.querySelector("#six_months").addEventListener("click", function (e) {
                r(e), o.updateOptions({ xaxis: { min: new Date("27 Sep 2012").getTime(), max: new Date("27 Feb 2013").getTime() } });
            }),
            document.querySelector("#one_year").addEventListener("click", function (e) {
                r(e), o.updateOptions({ xaxis: { min: new Date("27 Feb 2012").getTime(), max: new Date("27 Feb 2013").getTime() } });
            }),
            document.querySelector("#ytd").addEventListener("click", function (e) {
                r(e), o.updateOptions({ xaxis: { min: new Date("01 Jan 2013").getTime(), max: new Date("27 Feb 2013").getTime() } });
            }),
...
(dataColors = $("#area-chart-negative").data("colors")) && (colors = dataColors.split(","));
options = {
    chart: { height: 380, type: "area" },
    dataLabels: { enabled: !1 },
    ...
    yaxis: { tickAmount: 4, floating: !1, labels: { style: { color: "#8e8da4" }, offsetY: -7, offsetX: 0 }, axisBorder: { show: !1 }, axisTicks: { show: !1 } },
    fill: { opacity: 0.5, gradient: { enabled: !1 } },
    tooltip: { x: { format: "yyyy" }, fixed: { enabled: !1, position: "topRight" } },
    legend: { offsetY: 5 },
    grid: { yaxis: { lines: { offsetX: -30 } }, padding: { left: 0, bottom: 10 }, borderColor: "#f1f3fa" },
};
(chart = new ApexCharts(document.querySelector("#area-chart-negative"), options)).render();
colors = ["#FF7F00"];
(dataColors = $("#area-chart-github2").data("colors")) && (colors = dataColors.split(","));
var optionsarea2 = {
        chart: { id: "chartyear", type: "area", height: 200, toolbar: { show: !1, autoSelected: "pan" } },
        colors: colors,
...
chartarea2.render();
colors = ["#7BD39A"];
(dataColors = $("#area-chart-github").data("colors")) && (colors = dataColors.split(","));
options = {
    chart: {
        height: 175,
        type: "area",
        ...
        selection: { enabled: !0, xaxis: { min: new Date("05 Jan 2014").getTime(), max: new Date("04 Jan 2015").getTime() } },
    },
    colors: colors,
    dataLabels: { enabled: !1 },
    stroke: { width: 0, curve: "smooth" },
...
(dataColors = $("#stacked-area").data("colors")) && (colors = dataColors.split(","));
options = {
    chart: {
        height: 422,
        type: "area",
    ...
    series: [
        { name: "South", data: generateDayWiseTimeSeries(new Date("11 Feb 2017").getTime(), 20, { min: 10, max: 60 }) },
        { name: "North", data: generateDayWiseTimeSeries(new Date("11 Feb 2017").getTime(), 20, { min: 10, max: 20 }) },
        { name: "Central", data: generateDayWiseTimeSeries(new Date("11 Feb 2017").getTime(), 20, { min: 10, max: 15 }) },
    ],
...
for (var ts1 = 13885344e5, ts2 = 13886208e5, ts3 = 13890528e5, dataSet = [[], [], []], i = 0; i < 12; i++) {
...
(dataColors = $("#area-timeSeries").data("colors")) && (colors = dataColors.split(","));
options = {
    ...
    stroke: { width: 3 },
    fill: { gradient: { enabled: !0, shadeIntensity: 1, inverseColors: !1, opacityFrom: 0.45, opacityTo: 0.05, stops: [20, 100, 100, 100] } },
    yaxis: {
        labels: {
            style: { color: "#8e8da4" },
            offsetX: 0,
...
colors = ["#6c757d"];
(dataColors = $("#area-chart-nullvalues").data("colors")) && (colors = dataColors.split(","));
options = {
    chart: { height: 380, type: "area", animations: { enabled: !1 }, zoom: { enabled: !1 } },
    dataLabels: { enabled: !1 },
    ...
    fill: { opacity: 0.8, gradient: { enabled: !1 }, pattern: { enabled: !0, style: ["verticalLines", "horizontalLines"], width: 5, depth: 6 } },
