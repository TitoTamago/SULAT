!(function (c) {
    ...
    (t.prototype.respChart = function (e, r, a, o) {
        ...
        return (function () {
            var t;
            switch ((e.attr("width", c(s).width()), r)) {
                case "Line":
        ...
        (t.prototype.initCharts = function () {
            var t, e;
            0 < c("#high-performing-product").length &&
                ...
                (e = {
                    ...
                    datasets: [
                        { label: "Orders", backgroundColor: t, borderColor: t, hoverBackgroundColor: t, hoverBorderColor: t, data: [65, 59, 80, 81, 56, 89, 40, 32, 65, 59, 80, 81] },
                        {
                            label: "Revenue",
                ...
                [].push(
                    this.respChart(c("#high-performing-product"), "Bar", e, {
                        maintainAspectRatio: !1,
                        datasets: { bar: { barPercentage: 0.7, categoryPercentage: 0.5 } },
                        plugins: { legend: { display: !1 } },
                        scales: { y: { grid: { display: !1, color: "rgba(0,0,0,0.05)" }, stacked: !1, ticks: { stepSize: 20 } }, x: { stacked: !1, grid: { color: "rgba(0,0,0,0.01)" } } },
                    })
                ));
        }),
