!(function (t) {
    ...
    (o.prototype.markTodo = function (t, o) {
        ...
        (o.prototype.addTodo = function (t) {
            this.$todoData.push({ id: this.$todoData.length, text: t, done: !1 }), this.generate();
        }),
        ...
        (o.prototype.init = function () {
            ...
            this.generate(),
                ...
                this.$todoForm.on("submit", function (t) {
                    return (
                        t.preventDefault(),
                        "" == o.$todoInput.val() || void 0 === o.$todoInput.val() || null == o.$todoInput.val()
                            ? (o.$todoInput.focus(), !1)
                            : (o.addTodo(o.$todoInput.val()), o.$todoForm.removeClass("was-validated"), o.$todoInput.val(""), !0)
                    );
                });
        }),
        (t.TodoApp = new o()),
