...
!(function (a, b) {
    ...
    (j.prototype.createControl = function (a) {
        ...
        (b.style.cursor = "pointer"),
            a.disableDefaultStyles !== !0 && ((b.style.fontFamily = "Roboto, Arial, sans-serif"), (b.style.fontSize = "11px"), (b.style.boxShadow = "rgba(0, 0, 0, 0.298039) 0px 1px 4px -1px"));
    ...
    return (
        ...
        (j.createPanorama = function (b) {
            ...
            for (var d = ["closeclick", "links_changed", "pano_changed", "position_changed", "pov_changed", "resize", "visible_changed"], e = a({ visible: !0 }, b), f = 0; f < d.length; f++)
                delete e[d[f]];
