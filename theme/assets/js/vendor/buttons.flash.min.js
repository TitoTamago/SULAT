...
(function (g) {
            ...
            if (g.isPlainObject(c)) N(c);
                ...
                if (G) {
                    ...
                    for (f = d.attributes.length - 1; 0 <= f; f--) {
                        ...
                        var l = d.attributes[f].nodeValue;
                        -1 !== n.indexOf(":") && (e.push({ name: n, value: l }), d.removeAttribute(n));
                    }
                    f = 0;
                    for (n = e.length; f < n; f++) (l = c.createAttribute(e[f].name.replace(":", "_dt_b_namespace_token_"))), (l.value = e[f].value), d.setAttributeNode(l);
                }
    ...
    w.ext.buttons.excelFlash = g.extend({}, I, {
        ...
        action: function (a, b, c, d) {
            ...
            var l = b.buttons.exportData(d.exportOptions),
                ...
                p = function (h) {
                    ...
                    for (var k = 0, F = h.length; k < F; k++) {
                        ...
                        y ||
                            ("number" === typeof h[k] || (h[k].match && h[k].match(/^-?\d+(\.\d+)?$/) && !h[k].match(/^0\d+/))
                                ? (y = t(e, "c", { attr: { t: "n", r: K }, children: [t(e, "v", { text: h[k] })] }))
                                : ((D = h[k].replace ? h[k].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "") : h[k]),
            ...
            d.header && (p(l.header, f), g("row:last c", e).attr("s", "2"));
