...
(function (n) {
    ...
    function O(a, c) {
        ...
        n.each(c, function (d, b) {
            if (n.isPlainObject(b)) (d = a.folder(d)), O(d, b);
                ...
                J &&
                    (-1 === b.indexOf("<?xml") && (b = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + b),
                    ...
                    if (d) {
                        ...
                        (function () {
                            if ((m || (w && b)) && a.FileReader) {
                                ...
                                k || (k = (a.URL || a.webkitURL || a).createObjectURL(h)), w ? (a.location.href = k) : a.open(k, "_blank") || (a.location.href = k), (r.readyState = r.DONE), C(), f(k);
                        })();
                },
                t = p.prototype;
    ...
    D.ext.buttons.copyHtml5 = {
        ...
        action: function (a, c, d, b) {
                ...
                try {
                    ...
                    if (p) {
                        c.buttons.info(
                            ...
                            c.i18n("buttons.copySuccess", { 1: "Copied one row to clipboard", _: "Copied %d rows to clipboard" }, a.rows),
                            2e3
                        );
                        this.processing(!1);
                        return;
            ...
            p = n(
                "<span>" +
                    c.i18n("buttons.copyKeys", "Press <i>ctrl</i> or <i>⌘</i> + <i>C</i> to copy the table data<br>to your system clipboard.<br><br>To cancel, click this message or press escape.") +
                    "</span>"
            ).append(d);
        ...
        action: function (a, c, d, b) {
                            ...
                            ("number" === typeof k[l] || (k[l].match && k[l].match(/^-?\d+(\.\d+)?([eE]\-?\d+)?$/) && !k[l].match(/^0\d+/))
                                ...
                                : ((H = H.replace ? H.replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "") : H),
                                  (A = y(f, "c", {
                                      ...
                                      children: { row: y(f, "is", { children: { row: y(f, "t", { text: H, attr: { "xml:space": "preserve" } }) } }) },
                                  }))));
                        h.appendChild(A);
                    }
                    g.appendChild(h);
            ...
            b.autoFilter &&
                ...
                n("definedNames", q).append(
                    y(q, "definedName", { attr: { name: "_xlnm._FilterDatabase", localSheetId: "0", hidden: 1 }, text: Q(b) + "!$A$" + d + ":" + I(p.header.length - 1) + w })
                ));
