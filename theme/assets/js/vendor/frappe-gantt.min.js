var Gantt = (function () {
    ...
    var e = {
        parse(t, e = "-", s = /[.:]/) {
            ...
            if ("string" == typeof t) {
                let i, n;
                const a = t.split(" ");
                (i = a[0].split(e).map((t) => parseInt(t, 10))), (n = a[1] && a[1].split(s)), (i[1] = i[1] - 1);
                let o = i;
                return n && n.length && (4 == n.length && ((n[3] = "0." + n[3]), (n[3] = 1e3 * parseFloat(n[3]))), (o = o.concat(n))), new Date(...o);
            }
        },
        to_string(t, e = !1) {
            if (!(t instanceof Date)) throw new TypeError("Invalid argument type");
            const i = this.get_date_values(t).map((t, e) => (1 === e && (t += 1), s(t + "", 6 === e ? 3 : 2, "0"))),
                n = `${i[0]}-${i[1]}-${i[2]}`,
                a = `${i[3]}:${i[4]}:${i[5]}.${i[6]}`;
            return n + (e ? " " + a : "");
        },
        format(e, i = "YYYY-MM-DD HH:mm:ss.SSS", n = "en") {
            const a = this.get_date_values(e).map((t) => s(t, 2, 0)),
                o = { YYYY: a[0], MM: s(+a[1] + 1, 2, 0), DD: a[2], HH: a[3], mm: a[4], ss: a[5], SSS: a[6], D: a[2], MMMM: t[n][+a[1]], MMM: t[n][+a[1]] };
            let r = i;
            const h = [];
            return (
                Object.keys(o)
        ...
        diff(t, e, s = "day") {
            let i, n, a, o, r, h, d;
            return (
                (d = (h = (r = (a = (o = (n = (i = t - e) / 1e3) / 60) / 60) / 24) / 30) / 12),
                s.endsWith("s") || (s += "s"),
                Math.floor({ milliseconds: i, seconds: n, minutes: o, hours: a, days: r, months: h, years: d }[s])
            );
        },
        today() {
        ...
        get_date_values: (t) => [t.getFullYear(), t.getMonth(), t.getDate(), t.getHours(), t.getMinutes(), t.getSeconds(), t.getMilliseconds()],
        get_days_in_month(t) {
    ...
    function a(t, e, s, a) {
        const o = (function (t, e, s, a, o = "0.4s", r = "0.1s") {
            ...
            if (h) return i.attr(h, { attributeName: e, from: s, to: a, dur: o, begin: "click + " + r }), t;
            const d = n("animate", {
                attributeName: e,
                from: s,
                to: a,
                ...
                values: s + ";" + a,
                keyTimes: "0; 1",
                keySplines: ((p = "ease-out"), { ease: ".25 .1 .25 1", linear: "0 0 1 1", "ease-in": ".42 0 1 1", "ease-out": "0 0 .58 1", "ease-in-out": ".42 0 .58 1" }[p]),
            });
            var p;
    ...
    class o {
        ...
        prepare_values() {
            (this.invalid = this.task.invalid),
                ...
                (this.group = n("g", { class: "bar-wrapper " + (this.task.custom_class || ""), "data-id": this.task.id })),
                (this.bar_group = n("g", { class: "bar-group", append_to: this.group })),
                (this.handle_group = n("g", { class: "handle-group", append_to: this.group }));
        }
        prepare_helpers() {
        ...
        draw_bar() {
            (this.$bar = n("rect", { x: this.x, y: this.y, width: this.width, height: this.height, rx: this.corner_radius, ry: this.corner_radius, class: "bar", append_to: this.bar_group })),
        ...
        draw_label() {
            n("text", { x: this.x + this.width / 2, y: this.y + this.height / 2, innerHTML: this.task.name, class: "bar-label", append_to: this.bar_group }),
        ...
        draw_resize_handles() {
            ...
            n("rect", {
                ...
                n("rect", { x: t.getX() + 1, y: t.getY() + 1, width: 8, height: this.height - 2, rx: this.corner_radius, ry: this.corner_radius, class: "handle left", append_to: this.handle_group }),
                this.task.progress &&
                    this.task.progress < 100 &&
                    (this.$handle_progress = n("polygon", { points: this.get_progress_polygon_points().join(","), class: "handle progress", append_to: this.handle_group }));
        }
        ...
        show_popup() {
            ...
            const t = e.format(this.task._start, "MMM D", this.gantt.options.language) + " - " + e.format(e.add(this.task._end, -1, "second"), "MMM D", this.gantt.options.language);
        ...
        date_changed() {
            let t = !1;
            const { new_start_date: s, new_end_date: i } = this.compute_start_end_date();
        ...
        compute_start_end_date() {
            ...
            return { new_start_date: i, new_end_date: e.add(i, n * this.gantt.options.step, "hour") };
        }
        compute_progress() {
        ...
        get_snap_position(t) {
            ...
            return (s = this.gantt.view_is("Week")
                ? i - (e = t % (this.gantt.options.column_width / 7)) + (e < this.gantt.options.column_width / 14 ? 0 : this.gantt.options.column_width / 7)
                : this.gantt.view_is("Month")
                ? i - (e = t % (this.gantt.options.column_width / 30)) + (e < this.gantt.options.column_width / 60 ? 0 : this.gantt.options.column_width / 30)
                : i - (e = t % this.gantt.options.column_width) + (e < this.gantt.options.column_width / 2 ? 0 : this.gantt.options.column_width));
        }
        update_attr(t, e, s) {
        ...
        update_label_position() {
            ...
            e.getBBox().width > t.getWidth()
                ? (e.classList.add("big"), e.setAttribute("x", t.getX() + t.getWidth() + 5))
                : (e.classList.remove("big"), e.setAttribute("x", t.getX() + t.getWidth() / 2));
        }
    ...
    class h {
        ...
        show(t) {
            ...
            if (this.custom_html) {
                ...
                (e += '<div class="pointer"></div>'), (this.parent.innerHTML = e), (this.pointer = this.parent.querySelector(".pointer"));
    ...
    const d = { QUARTER_DAY: "Quarter Day", HALF_DAY: "Half Day", DAY: "Day", WEEK: "Week", MONTH: "Month", YEAR: "Year" };
    class p {
        constructor(t, e, s) {
        ...
        setup_wrapper(t) {
            let e, s;
            if (("string" == typeof t && (t = document.querySelector(t)), t instanceof HTMLElement)) (s = t), (e = t.querySelector("svg"));
            else {
            ...
            e ? ((this.$svg = e), this.$svg.classList.add("gantt")) : (this.$svg = n("svg", { append_to: s, class: "gantt" })),
        ...
        setup_tasks(t) {
            (this.tasks = t.map((t, s) => {
                if (((t._start = e.parse(t.start)), (t._end = e.parse(t.end)), e.diff(t._end, t._start, "year") > 10 && (t.end = null), (t._index = s), !t.start && !t.end)) {
                    const s = e.today();
        ...
        update_view_scale(t) {
            (this.options.view_mode = t),
                t === d.DAY
                    ...
                    : t === d.YEAR && ((this.options.step = 8760), (this.options.column_width = 120));
        }
        setup_dates() {
        ...
        setup_gantt_dates() {
            ...
            for (let t of this.tasks) (!this.gantt_start || t._start < this.gantt_start) && (this.gantt_start = t._start), (!this.gantt_end || t._end > this.gantt_end) && (this.gantt_end = t._end);
            (this.gantt_start = e.start_of(this.gantt_start, "day")),
                ...
                this.view_is([d.QUARTER_DAY, d.HALF_DAY])
                    ? ((this.gantt_start = e.add(this.gantt_start, -7, "day")), (this.gantt_end = e.add(this.gantt_end, 7, "day")))
                    : this.view_is(d.MONTH)
                    ? ((this.gantt_start = e.start_of(this.gantt_start, "year")), (this.gantt_end = e.add(this.gantt_end, 1, "year")))
                    : this.view_is(d.YEAR)
                    ? ((this.gantt_start = e.add(this.gantt_start, -2, "year")), (this.gantt_end = e.add(this.gantt_end, 2, "year")))
                    : ((this.gantt_start = e.add(this.gantt_start, -1, "month")), (this.gantt_end = e.add(this.gantt_end, 1, "month")));
        }
        setup_date_values() {
            this.dates = [];
            let t = null;
        ...
        setup_layers() {
            ...
            for (let e of t) this.layers[e] = n("g", { class: e, append_to: this.$svg });
        }
        make_grid() {
        ...
        make_grid_rows() {
            ...
            for (let o of this.tasks)
                n("rect", { x: 0, y: a, width: s, height: i, class: "grid-row", append_to: t }),
                    n("line", { x1: 0, y1: a + i, x2: s, y2: a + i, class: "row-line", append_to: e }),
        ...
        make_grid_ticks() {
            let t = 0,
                ...
                i = (this.options.bar_height + this.options.padding) * this.tasks.length;
            for (let a of this.dates) {
                ...
                this.view_is(d.DAY) && 1 === a.getDate() && (o += " thick"),
                    ...
                    n("path", { d: `M ${t} ${s} v ${i}`, class: o, append_to: this.layers.grid }),
        ...
        make_grid_highlights() {
            if (this.view_is(d.DAY)) {
                n("rect", {
                    x: (e.diff(e.today(), this.gantt_start, "hour") / this.options.step) * this.options.column_width,
                    y: 0,
        ...
        make_dates() {
            for (let t of this.get_dates_to_draw())
                if ((n("text", { x: t.lower_x, y: t.lower_y, innerHTML: t.lower_text, class: "lower-text", append_to: this.layers.date }), t.upper_text)) {
                    const e = n("text", { x: t.upper_x, y: t.upper_y, innerHTML: t.upper_text, class: "upper-text", append_to: this.layers.date });
        ...
        get_date_info(t, s, i) {
            ...
            const n = {
                    ...
                    Week_lower: t.getMonth() !== s.getMonth() ? e.format(t, "D MMM", this.options.language) : e.format(t, "D", this.options.language),
                    Month_lower: e.format(t, "MMMM", this.options.language),
                    Year_lower: e.format(t, "YYYY", this.options.language),
                    "Quarter Day_upper": t.getDate() !== s.getDate() ? e.format(t, "D MMM", this.options.language) : "",
                    "Half Day_upper": t.getDate() !== s.getDate() ? (t.getMonth() !== s.getMonth() ? e.format(t, "D MMM", this.options.language) : e.format(t, "D", this.options.language)) : "",
                    Day_upper: t.getMonth() !== s.getMonth() ? e.format(t, "MMMM", this.options.language) : "",
                    Week_upper: t.getMonth() !== s.getMonth() ? e.format(t, "MMMM", this.options.language) : "",
                    Month_upper: t.getFullYear() !== s.getFullYear() ? e.format(t, "YYYY", this.options.language) : "",
                    Year_upper: t.getFullYear() !== s.getFullYear() ? e.format(t, "YYYY", this.options.language) : "",
                },
        ...
        set_scroll_position() {
            ...
            if (!t) return;
            const s = (e.diff(this.get_oldest_starting_date(), this.gantt_start, "hour") / this.options.step) * this.options.column_width - this.options.column_width;
            t.scrollLeft = s;
        }
        bind_grid_click() {
            ...
            (this.bar_being_dragged = null),
                i.on(this.$svg, "mousedown", ".bar-wrapper, .handle", (h, d) => {
                    ...
                    d.classList.contains("left") ? (n = !0) : d.classList.contains("right") ? (a = !0) : d.classList.contains("bar-wrapper") && (t = !0),
                        ...
                        (e = h.offsetX),
                        (s = h.offsetY);
                    const _ = [(o = p.getAttribute("data-id")), ...this.get_all_dependent_tasks(o)];
                ...
                i.on(this.$svg, "mousemove", (s) => {
                    ...
                    r.forEach((e) => {
                        ...
                        (s.finaldx = this.get_snap_position(i)),
                            n
                                ? o === e.task.id
                                    ? e.update_bar_position({ x: s.ox + s.finaldx, width: s.owidth - s.finaldx })
                                    : e.update_bar_position({ x: s.ox + s.finaldx })
                                : a
                                ? o === e.task.id && e.update_bar_position({ width: s.owidth + s.finaldx })
                                : t && e.update_bar_position({ x: s.ox + s.finaldx });
                    });
                }),
                document.addEventListener("mouseup", (e) => {
                    (t || n || a) && r.forEach((t) => t.group.classList.remove("active")), (t = !1), (n = !1), (a = !1);
                }),
        ...
        bind_bar_progress() {
            ...
            i.on(this.$svg, "mousedown", ".handle.progress", (r, h) => {
                ...
                (n = this.get_bar(d)), (a = n.$bar_progress), (o = n.$bar), (a.finaldx = 0), (a.owidth = a.getWidth()), (a.min_dx = -a.getWidth()), (a.max_dx = o.getWidth() - a.getWidth());
            }),
                i.on(this.$svg, "mousemove", (e) => {
                    ...
                    i.attr(a, "width", a.owidth + o), i.attr(r, "points", n.get_progress_polygon_points()), (a.finaldx = o);
                }),
                i.on(this.$svg, "mouseup", () => {
                    (s = !1), a && a.finaldx && (n.progress_changed(), n.set_action_completed());
                });
        }
        ...
        get_snap_position(t) {
            ...
            return (s = this.view_is(d.WEEK)
                ? i - (e = t % (this.options.column_width / 7)) + (e < this.options.column_width / 14 ? 0 : this.options.column_width / 7)
                : this.view_is(d.MONTH)
                ? i - (e = t % (this.options.column_width / 30)) + (e < this.options.column_width / 60 ? 0 : this.options.column_width / 30)
                : i - (e = t % this.options.column_width) + (e < this.options.column_width / 2 ? 0 : this.options.column_width));
        }
        unselect_all() {
