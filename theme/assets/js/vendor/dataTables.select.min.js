...
(function (h) {
    ...
    function N(a) {
        ...
        if (b._select.info && b.aanFeatures.i && "api" !== a.select.style()) {
            var c = a.rows({ selected: !0 }).flatten().length,
                ...
                g = function (f, k, n) {
                    f.append(h('<span class="select-item"/>').append(a.i18n("select." + k + "s", { _: "%d " + k + "s selected", 0: "", 1: "1 " + k + " selected" }, n)));
                };
    ...
    function z(a, b) {
        if (b || "single" === a._select.style) (a = new m.Api(a)), a.rows({ selected: !0 }).deselect(), a.columns({ selected: !0 }).deselect(), a.cells({ selected: !0 }).deselect();
    }
            ...
            var c = a.state.loaded(),
                d = function (t, G, p) {
                    if (null !== p && p.select !== l) {
                        ...
                        if (p.select.cells !== l) for (t = 0; t < p.select.cells.length; t++) a.cell(p.select.cells[t].row, p.select.cells[t].column).select();
                        a.state.save();
                    }
                };
            a.one("init", function () {
