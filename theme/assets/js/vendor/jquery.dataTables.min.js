...
(function (l) {
    ...
    function T(a, b, c, d) {
        ...
        if (k === q)
            return (
                a.iDrawError != e &&
                    null === g &&
                    (da(a, 0, "Requested unknown parameter " + ("function" == typeof h.mData ? "{function}" : "'" + h.mData + "'") + " for row " + b + ", column " + c, 4), (a.iDrawError = e)),
                g
            );
    ...
    function Kb(a) {
        ...
        var k = function (n) {
            ...
            (e.return && "Enter" !== n.key) ||
                p == e.sSearch ||
                (za(a, { sSearch: p, bRegex: e.bRegex, bSmart: e.bSmart, bCaseInsensitive: e.bCaseInsensitive, return: e.return }), (a._iDisplayStart = 0), ja(a));
        };
    ...
    function cc(a) {
        ...
        for (var d = 0, e = b.length; d < e; d++) {
            ...
            h.bSortable &&
                (0 < c.length && c[0].col == d ? (k.setAttribute("aria-sort", "asc" == c[0].dir ? "ascending" : "descending"), (h = f[c[0].index + 1] || f[0])) : (h = f[0]),
    ...
    function nb(a, b, c, d) {
        ...
        c && a.oFeatures.bSortMulti
            ? ((c = l.inArray(b, U(e, "0"))),
              -1 !== c
                  ? ((b = f(e[c], !0)), null === b && 1 === e.length && (b = 0), null === b ? e.splice(c, 1) : ((e[c][1] = h[b]), (e[c]._idx = b)))
    ...
    var yc = function (a, b, c, d) {
        ...
        qc = function (a, b) {
            ...
            if (c.length && a.length) {
                ...
                d._details &&
                    ((d._detailsShow = b) ? (d._details.insertAfter(d.nTr), l(d.nTr).addClass("dt-hasChild")) : (d._details.detach(), l(d.nTr).removeClass("dt-hasChild")),
    ...
    y("search()", function (a, b, c, d) {
        ...
        return a === q
            ...
            : this.iterator("table", function (h) {
                  h.oFeatures.bFilter &&
                      za(h, l.extend({}, h.oPreviousSearch, { sSearch: a + "", bRegex: null === b ? !1 : b, bSmart: null === c ? !0 : c, bCaseInsensitive: null === d ? !0 : d }), 1);
              });
    });
