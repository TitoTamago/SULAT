...
var FullCalendar = (function (e) {
            ...
            ? (function (e) {
                  ...
                  if (t) {
                      ...
                      return {
                          ...
                          milliseconds:
                              n *
                              (60 * (t[3] ? parseInt(t[3], 10) : 0) * 60 * 1e3 + 60 * (t[4] ? parseInt(t[4], 10) : 0) * 1e3 + 1e3 * (t[5] ? parseInt(t[5], 10) : 0) + (t[6] ? parseInt(t[6], 10) : 0)),
                      };
                  }
                  return null;
              })(e)
    ...
    function Hn(e, t, n, r, o) {
        ...
        if (u)
            return ((c = Ln(a, s, t ? t.sourceId : "", u.allDay, Boolean(u.duration), n)).recurringDef = { typeId: u.typeId, typeData: u.typeData, duration: u.duration }), { def: c, instance: null };
        var c,
            d = (function (e, t, n, r) {
                var o,
                    i,
    ...
    function Gn(e, t) {
        return (
            (null === e.start ? null : e.start.valueOf()) === (null === t.start ? null : t.start.valueOf()) && (null === e.end ? null : e.end.valueOf()) === (null === t.end ? null : t.end.valueOf())
        );
    }
    function qn(e, t) {
            ...
            return (
                (e.prototype.setProp = function (e, t) {
                    ...
                    if (e in Pn) console.warn("Could not set date-related prop 'name'. Use one of the date-related methods instead.");
                        ...
                        var o = _n[e](t);
                        "color" === e ? (o = { backgroundColor: t, borderColor: t }) : "editable" === e ? (o = { startEditable: t, durationEditable: t }) : (((r = {})[e] = t), (o = r)),
    ...
    function oo(e, t) {
        ...
        return (
            e.isDisabled
                ...
                : (e.isToday && (n.push("fc-day-today"), n.push(t.getClass("today"))), e.isPast && n.push("fc-day-past"), e.isFuture && n.push("fc-day-future"), e.isOther && n.push("fc-day-other")),
            n
        );
    }
                    ...
                    return (
                        e && e.contentKey === n.contentKey
                            ...
                            : (e && (e.destroy && e.destroy(), (e = this.customContentInfo = null)),
                              n.contentKey && (e = this.customContentInfo = r({ contentKey: n.contentKey, contentVal: t[n.contentKey] }, n.buildLifecycleFuncs()))),
                        e ? [] : t
                    );
                }),
                        ...
                        if ("title" === u) (i = !1), r.push(_o("h2", { className: "fc-toolbar-title", id: t.titleId }, t.title));
                            ...
                            h && g.push(n.getClass("buttonActive")),
                                r.push(
                                    _o(
                                        "button",
                                        { type: "button", title: "function" == typeof f ? f(t.navUnit) : f, disabled: v, "aria-pressed": h, className: g.join(" "), onClick: c },
                ...
                return (
                    (n.handleSegClick = function (e, t) {
                        ...
                        if (i && r.isValidSegDownEl(e.target)) {
                            ...
                            o.emitter.trigger("eventClick", { el: t, event: new xr(r.context, i.eventRange.def, i.eventRange.instance), jsEvent: e, view: o.viewApi }),
    ...
    var Sa = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return _o(
                        Yo,
                        { hookProps: f, classNames: n.dayHeaderClassNames, content: n.dayHeaderContent, defaultContent: Ea, didMount: n.dayHeaderDidMount, willUnmount: n.dayHeaderWillUnmount },
                        function (e, t, n, o) {
                            return _o(
                                "th",
                                ...
                                _o(
                                    ...
                                    !u.isDisabled && _o("a", r({ ref: n, className: ["fc-col-header-cell-cushion", a.isSticky ? "fc-sticky" : ""].join(" ") }, p), o)
                                )
                            );
                        }
                    );
        ...
        Da = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return _o(
                        Yo,
                        { hookProps: d, classNames: a.dayHeaderClassNames, content: a.dayHeaderContent, defaultContent: Ea, didMount: a.dayHeaderDidMount, willUnmount: a.dayHeaderWillUnmount },
                        function (t, o, i, a) {
                            return _o(
                                "th",
                                ...
                                _o(
                                    "div",
                                    { className: "fc-scrollgrid-sync-inner" },
                                    _o("a", { "aria-label": n.format(s, ba), className: ["fc-col-header-cell-cushion", e.isSticky ? "fc-sticky" : ""].join(" "), ref: i }, a)
                                )
                            );
                        }
                    );
            ...
            (t.prototype.render = function () {
                ...
                return _o(Ca, { unit: "day" }, function (e, t) {
                    return _o(
                        ...
                        n.map(function (e) {
                            return o
                                ? _o(Sa, { key: e.toISOString(), date: e, dateProfile: r, todayRange: t, colCnt: n.length, dayHeaderFormat: a })
        ...
        return (
            ...
            (t.prototype.renderSection = function (e, t, n) {
                return "outerContent" in e
                    ...
                    : _o("tr", { key: e.key, role: "presentation", className: $a(e, this.props.liquid).join(" ") }, this.renderChunkTd(e, t, e.chunk, n));
            }),
            ...
            (o.subjectEl = null),
                ...
                (o.handleDragStart = function (e) {
                    ...
                    e.isTouch ? r !== o.component.props.eventSelection && t.dispatch({ type: "SELECT_EVENT", eventInstanceId: r }) : t.dispatch({ type: "UNSELECT_EVENT" }),
                        o.isDragging &&
                            (t.calendarApi.unselect(e), t.emitter.trigger("eventDragStart", { el: o.subjectEl, event: new xr(t, n.def, n.instance), jsEvent: e.origEvent, view: t.viewApi }));
                }),
                        ...
                        if (e) {
                            ...
                            i === a || (d.editable && d.droppable)
                                ? (s = (function (e, t, n) {
                                  ...
                                  (c.mutatedEvents = l),
                                  Ia(c, e.dateProfile, a) || ((u = !0), (s = null), (l = null), (c.mutatedEvents = { defs: {}, instances: {} })))
                                : (a = null);
                        }
                        o.displayDrag(a, c),
                            u ? Ue() : We(),
            ...
            (n.draggingSegEl = null),
                ...
                (n.handleDragStart = function (e) {
                    ...
                    (n.draggingSegEl = o),
                        ...
                        t.emitter.trigger("eventResizeStart", { el: o, event: new xr(t, r.def, r.instance), jsEvent: e.origEvent, view: t.viewApi });
                }),
                ...
                (n.handleDragEnd = function (e) {
                    ...
                    if ((t.emitter.trigger("eventResizeStop", { el: n.draggingSegEl, event: a, jsEvent: e.origEvent, view: t.viewApi }), n.validMutation)) {
                        ...
                        t.emitter.trigger(
                            "eventResize",
                            r(r({}, c), { el: n.draggingSegEl, startDelta: n.validMutation.startDelta || Nt(0), endDelta: n.validMutation.endDelta || Nt(0), jsEvent: e.origEvent, view: t.viewApi })
                        ),
                    ...
                    return (
                        ...
                        _o(ti, { viewSpec: r.viewSpec }, function (e, t) {
                            return _o(
                                ...
                                _o(ts, { liquid: !n.isHeightAuto && !n.forPrint, collapsibleWidth: n.forPrint, cols: [], sections: o })
                            );
                        })
                    );
                }),
    ...
    var nl = (function (e) {
        ...
        return (
            ...
            (t.prototype.render = function () {
                ...
                return _o(
                    ss,
                    { date: e.date, dateProfile: e.dateProfile, todayRange: e.todayRange, showDayNumber: e.showDayNumber, extraHookProps: e.extraHookProps, defaultContent: rl },
                    function (n, o) {
                        return (
                            (o || e.forceDayTop) &&
                            _o("div", { className: "fc-daygrid-day-top", ref: n }, _o("a", r({ id: e.dayNumberId, className: "fc-daygrid-day-number" }, t), o || _o(xo, null, " ")))
                        );
                    }
                );
            }),
                    ...
                    return _o(
                        ...
                        function (e, t, u, c) {
                            return _o(
                                "td",
                                r(
                                    { ref: e, role: "gridcell", className: ["fc-daygrid-day"].concat(t, n.extraClassNames || []).join(" ") },
                                    u,
                                    n.extraDataAttrs,
    ...
    function _l(e) {
        ...
        return _o(Oo.Consumer, null, function (n) {
            ...
            return _o(
                Yo,
                { hookProps: s, classNames: o.slotLabelClassNames, content: o.slotLabelContent, defaultContent: Tl, didMount: o.slotLabelDidMount, willUnmount: o.slotLabelWillUnmount },
                function (n, r, o, i) {
                    return _o(
                        "td",
                        ...
                        _o(
                            ...
                            _o("div", { className: "fc-timegrid-slot-label-cushion fc-scrollgrid-shrink-cushion", ref: o }, i)
                        )
                    );
                }
            );
            ...
            function t() {
                ...
                return (
                    ...
                    (t.renderTableRowAxis = function (e) {
                        ...
                        return _o(
                            Yo,
                            { hookProps: i, classNames: r.allDayClassNames, content: r.allDayContent, defaultContent: Il, didMount: r.allDayDidMount, willUnmount: r.allDayWillUnmount },
                            function (t, n, r, o) {
                                return _o(
                                    "td",
                    ...
                    return (
                        ...
                        _o(ti, { viewSpec: r.viewSpec, elRef: this.rootElRef }, function (e, t) {
                            return _o(
                                ...
                                _o(ts, { liquid: !o.isHeightAuto && !o.forPrint, collapsibleWidth: o.forPrint, cols: [{ width: "shrink" }], sections: i })
                            );
                        })
                    );
                }),
                        ...
                        t &&
                            ...
                            f.push({
                                ...
                                outerContent: _o(
                                    "tr",
                                    { role: "presentation", className: "fc-scrollgrid-section" },
                                    _o("td", { colSpan: 2, className: "fc-timegrid-divider " + u.theme.getClass("tableCellShaded") })
                                ),
                            }));
        ...
        return _o(
            ...
            e.map(function (e) {
                ...
                return _o(
                    ...
                    _o(ql, r({ seg: e, isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: t === i, isShort: !1 }, sr(e, n, o)))
                );
            })
        );
    }
        ...
        lu = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return _o(
                        Yo,
                        { hookProps: h, classNames: o.dayHeaderClassNames, content: o.dayHeaderContent, defaultContent: uu, didMount: o.dayHeaderDidMount, willUnmount: o.dayHeaderWillUnmount },
                        function (e, n, r, o) {
                            return _o(
                                "tr",
    ...
    function uu(e) {
        return _o(
            ...
            e.sideText && _o("a", r({ "aria-hidden": !0, className: "fc-list-day-side-text" }, e.sideNavLinkAttrs), e.sideText)
        );
    }
                        ...
                        function (e, r, l, u, c) {
                            return _o(
                                ...
                                _o(
                                    ...
                                    _o("span", { className: "fc-list-event-dot", style: { borderColor: c.borderColor || c.backgroundColor } })
                                ),
    ...
    var fu = (function (e) {
        ...
        return (
            ...
            (t.prototype.renderEmptyMessage = function () {
                ...
                return _o(
                    Yo,
                    { hookProps: r, classNames: t.noEventsClassNames, content: t.noEventsContent, defaultContent: hu, didMount: t.noEventsDidMount, willUnmount: t.noEventsWillUnmount },
                    function (e, t, n, r) {
    ...
    return (
        ...
        (e.formatRange = function (e, t, n) {
            ...
            return i && a
                ? r.formatRange(i.marker, a.marker, o, { forcedStartTzo: i.forcedTzo, forcedEndTzo: a.forcedTzo, isEndExclusive: n.isEndExclusive, defaultSeparator: cn.defaultRangeSeparator })
                : "";
        }),
