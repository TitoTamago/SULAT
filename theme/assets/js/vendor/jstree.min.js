        ...
        !j &&
            ...
            (a.jstree.core = function (a) {
                (this._id = a),
                    (this._cnt = 0),
                    (this._wrk = null),
                    (this._data = { core: { themes: { name: !1, dots: !1, icons: !1, ellipsis: !1 }, selected: [], last_error: {}, working: !1, worker_queue: [], focused: null } });
            }),
            ...
            (a.jstree.core.prototype = {
                        ...
                        ? a.vakata.is_function(d)
                            ...
                            ? d.url
                                ? ((d = a.extend(!0, {}, d)),
                                  ...
                                  a.vakata.is_function(d.data) && (d.data = d.data.call(this, b)),
                                  a
                                      .ajax(d)
                                      .done(
                                          function (d, e, g) {
                                ...
                                : ((e = a.vakata.is_array(d) ? a.extend(!0, [], d) : a.isPlainObject(d) ? a.extend(!0, {}, d) : d),
                                  b.id === a.jstree.root
                            ...
                            i = function (a, b) {
                                ...
                                var c = a.dat,
                                    ...
                                    s = function (a, c, d) {
                                        ...
                                        for (
                                            a && a.children && a.children === !0 && ((m.state.loaded = !1), (m.children = []), (m.children_d = [])), l[m.id] = m, f = 0, h = m.children.length;
                                            h > f;
                                            f++
                                        )
                                            (j = s(l[m.children[f]], m.id, d)), (k = l[j]), m.children_d.push(j), k.children_d.length && (m.children_d = m.children_d.concat(k.children_d));
                                    ...
                                    t = function (a, c, d) {
                                        ...
                                        if (a && a.children && a.children.length) {
                                            for (f = 0, h = a.children.length; h > f; f++)
                                                (m = t(a.children[f], o.id, d)), (n = l[m]), o.children.push(m), n.children_d.length && (o.children_d = o.children_d.concat(n.children_d));
                ...
                _redraw: function () {
                    ...
                    this._model.force_full_redraw && ((c.className = this.get_container_ul()[0].className), c.setAttribute("role", "group"), this.element.empty().append(c)),
                        null !== g &&
                            ...
                            ((d = this.get_node(g, !0)),
                            d && d.length && d.children(".jstree-anchor")[0] !== i.activeElement ? d.children(".jstree-anchor").trigger("focus") : (this._data.core.focused = null)),
                ...
                redraw_node: function (b, c, d, e) {
                    ...
                    if (
                        ...
                        (b = i.querySelector
                            ? this.element[0].querySelector(
                                  "#" + (-1 !== "0123456789".indexOf(f.id[0]) ? "\\3" + f.id[0] + " " + f.id.substr(1).replace(a.jstree.idregex, "\\$&") : f.id.replace(a.jstree.idregex, "\\$&"))
                              )
                        ...
                        if (((g = f.parent !== a.jstree.root ? a("#" + f.parent.replace(a.jstree.idregex, "\\$&"), this.element)[0] : null), !(null === g || (g && p[f.parent].state.opened))))
                            return !1;
                    ...
                    for (
                        f.a_attr.id || (f.a_attr.id = f.id + "_anchor"),
                            ...
                            this.settings.core.compute_elements_positions &&
                                (b.childNodes[1].setAttribute("aria-setsize", p[f.parent].children.length), b.childNodes[1].setAttribute("aria-posinset", p[f.parent].children.indexOf(f.id) + 1)),
                    ...
                    f.state.hidden && (n += " jstree-hidden"),
                        ...
                        f.state.loaded && !v
                            ? (n += " jstree-leaf")
                            : ((n += f.state.opened && f.state.loaded ? " jstree-open" : " jstree-closed"), b.childNodes[1].setAttribute("aria-expanded", f.state.opened && f.state.loaded)),
                ...
                hide_node: function (b, c) {
                    ...
                    return (
                        (b = this.get_node(b)),
                        b && b.id !== a.jstree.root ? void (b.state.hidden || ((b.state.hidden = !0), this._node_changed(b.parent), c || this.redraw(), this.trigger("hide_node", { node: b }))) : !1
                    );
                },
                show_node: function (b, c) {
                    ...
                    return (
                        (b = this.get_node(b)),
                        b && b.id !== a.jstree.root ? void (b.state.hidden && ((b.state.hidden = !1), this._node_changed(b.parent), c || this.redraw(), this.trigger("show_node", { node: b }))) : !1
                    );
                },
                hide_all: function (b) {
                    var c,
                ...
                activate_node: function (a, c) {
                    ...
                    if (
                        ...
                        this.settings.core.multiple &&
                            ...
                            (!c.shiftKey || (this._data.core.last_clicked && this.get_parent(a) && this.get_parent(a) === this._data.core.last_clicked.parent)))
                    )
                        if (c.shiftKey) {
                ...
                set_state: function (c, d) {
                    if (c) {
                        if ((c.core && c.core.selected && c.core.initial_selection === b && (c.core.initial_selection = this._data.core.selected.concat([]).sort().join(",")), c.core)) {
                            ...
                            if (c.core.loaded)
                                return (
                                    this.settings.core.loaded_state && a.vakata.is_array(c.core.loaded) && c.core.loaded.length
                ...
                refresh: function (b, c) {
                    (this._data.core.state = c === !0 ? {} : this.get_state()),
                        c && a.vakata.is_function(c) && (this._data.core.state = c.call(this, this._data.core.state)),
                        (this._cnt = 0),
                        (this._model.data = {}),
                        (this._model.data[a.jstree.root] = { id: a.jstree.root, parent: null, parents: [], children: [], children_d: [], state: { loaded: !1 } }),
                        (this._data.core.selected = []),
                ...
                set_text: function (b, c) {
                    ...
                    return (
                        (b = this.get_node(b)),
                        b && b.id !== a.jstree.root ? ((b.text = c), this.get_node(b, !0).length && this.redraw_node(b.id), this.trigger("set_text", { obj: b, text: c }), !0) : !1
                    );
                },
                ...
                delete_node: function (b) {
                    ...
                    return (
                        -1 !== a.inArray(this._data.core.focused, g) &&
                            ...
                            e.id === a.jstree.root
                                ? this._model.data[a.jstree.root].children[0] && this.get_node(this._model.data[a.jstree.root].children[0], !0).children(".jstree-anchor").triger("focus")
                    ...
                    return (
                        ...
                        g && g.functions && (g.functions[b] === !1 || g.functions[b] === !0)
                            ? (g.functions[b] === !1 &&
                              ...
                              g.functions[b])
                            : h === !1 || (a.vakata.is_function(h) && h.call(this, b, c, d, e, f) === !1) || (h && h[b] === !1)
                            ? ((this._data.core.last_error = {
                                  error: "check",
                                  plugin: "core",
                                  id: "core_03",
                ...
                move_node: function (c, d, e, f, g, h, i) {
                    ...
                    if (
                        ...
                        !this.check("move_node", c, n, e, { core: !0, origin: i, is_multi: o && o._id && o._id !== this._id, is_foreign: !o || !o._id }))
                    )
                        return this.settings.core.error.call(this, this._data.core.last_error), !1;
                    if (c.parent === n.id) {
                ...
                copy_node: function (c, d, e, f, g, h, i) {
                    ...
                    if (
                        ...
                        !this.check("copy_node", c, r, e, { core: !0, origin: i, is_multi: s && s._id && s._id !== this._id, is_foreign: !s || !s._id }))
                    )
                        return this.settings.core.error.call(this, this._data.core.last_error), !1;
                    ...
                    return (b = this.get_node(b))
                        ? this.check("edit", b, this.get_parent(b))
                            ? ((n = b),
                              ...
                              (h = a("<span></span>")),
                              (j = c),
                              (k = a("<div></div>", { css: { position: "absolute", top: "-200px", left: e ? "0px" : "-1000px", visibility: "hidden" } }).appendTo(i.body)),
                              (l = a("<input />", {
                                  value: j,
                ...
                hide_icon: function (b) {
                    ...
                    return (
                        (b = this.get_node(b)),
                        b && b !== a.jstree.root ? ((b.icon = !1), this.get_node(b, !0).children(".jstree-anchor").children(".jstree-themeicon").addClass("jstree-themeicon-hidden"), !0) : !1
                    );
                },
                ...
                (this.bind = function () {
                                        ...
                                        if (c.state.loaded) {
                                            for (d = 0, e = c.children_d.length; e > d; d++)
                                                if (
                                                    ...
                                                    for (h[j.id] === b && j.id !== a.jstree.root && ((h[j.id] = !0), l.push(j.id)), f = 0, g = j.parents.length; g > f; f++)
                                            ...
                                            for (h[c.id] === b && c.id !== a.jstree.root && ((h[c.id] = !0), l.push(c.id)), f = 0, g = c.parents.length; g > f; f++)
                    ...
                    (this._undetermined = function () {
                        if (null !== this.element) {
                            ...
                            for (this.element.find(".jstree-undetermined").removeClass("jstree-undetermined"), b = 0, c = a.length; c > b; b++)
                                (d = this.get_node(a[b], !0)), d && d.length && d.children(".jstree-anchor").children(".jstree-checkbox").addClass("jstree-undetermined");
                        }
                    }),
                    (this.redraw_node = function (a, b, c, e) {
                        if ((a = d.redraw_node.apply(this, arguments))) {
                            ...
                            h &&
                                (!this.settings.checkbox.tie_selection && this._model.data[a.id].state.checked && (h.className += " jstree-checked"),
                                (i = l.cloneNode(!1)),
                                this._model.data[a.id].state.checkbox_disabled && (i.className += " jstree-checkbox-disabled"),
                    ...
                    this.element
                        ...
                        .on("touchmove.vakata.jstree", function (b) {
                            c &&
                                ...
                                b.originalEvent.changedTouches &&
                                b.originalEvent.changedTouches[0] &&
                                (Math.abs(e - b.originalEvent.changedTouches[0].clientX) > 10 || Math.abs(f - b.originalEvent.changedTouches[0].clientY) > 10) &&
            ...
            (function (a) {
                ...
                (a.vakata.context = {
                    ...
                    _execute: function (b) {
                        return (
                            (b = c.items[b]),
                            b && (!b._disabled || (a.vakata.is_function(b._disabled) && !b._disabled({ item: b, reference: c.reference, element: c.element }))) && b.action
                            ...
                            a.each(b, function (b, d) {
                                return d
                                    ? (c.items.push(d),
                                      !f &&
                                          d.separator_before &&
                                          (e += "<li class='vakata-context-separator'><a href='#' " + (a.vakata.context.settings.icons ? "" : 'class="vakata-context-no-icons"') + ">&#160;</a></li>"),
                                      (f = !1),
                                      (e +=
                                          "<li class='" +
                                          (d._class || "") +
                                          (d._disabled === !0 || (a.vakata.is_function(d._disabled) && d._disabled({ item: d, reference: c.reference, element: c.element }))
                                      ...
                                      (e +=
                                          (a.vakata.is_function(d.label) ? d.label({ item: b, reference: c.reference, element: c.element }) : d.label) +
                    ...
                    show: function (d, e, f) {
                        ...
                        d && !f && a(d).data("vakata_contextmenu") && (f = a(d).data("vakata_contextmenu")),
                            ...
                            c.items.length &&
                                ...
                                j + l + 20 > n && (j = n - (l + 20)),
                                k + m + 20 > o && (k = o - (m + 20)),
                                c.element.css({ left: j, top: k }).show().find("a").first().trigger("focus").parent().addClass("vakata-context-hover"),
                                (c.is_visible = !0),
                        ...
                        (c.element = a("<ul class='vakata-context'></ul>")),
                            c.element
                                ...
                                .on("click", "a", function (b) {
                                    b.preventDefault(),
                                        a(this).trigger("blur").parent().hasClass("vakata-context-disabled") || a.vakata.context._execute(a(this).attr("rel")) === !1 || a.vakata.context.hide();
                                })
                                    ...
                                    switch (b.which) {
                                        ...
                                        case 38:
                                            c.is_visible &&
                                                ...
                                                d.addClass("vakata-context-hover").children("a").trigger("focus"),
                                                b.stopImmediatePropagation(),
                                                b.preventDefault());
                                            break;
                                        case 39:
                            ...
                            function (b) {
                                ...
                                if (
                                    ...
                                    (!this.settings.dnd.touch ||
                                        ("selected" === this.settings.dnd.touch && !a(b.currentTarget).closest(".jstree-node").children(".jstree-anchor").hasClass("jstree-clicked")))
                                )
                                    return !0;
                                ...
                                if (
                                    ...
                                    c &&
                                        ...
                                        (this.settings.dnd.is_draggable === !0 ||
                                            (a.vakata.is_function(this.settings.dnd.is_draggable) && this.settings.dnd.is_draggable.call(this, d > 1 ? this.get_top_selected(!0) : [c], b))))
                                ) {
                                    if (
                                        ...
                                        l &&
                                            ...
                                            a.each(u, function (b, e) {
                                                ...
                                                for (v = !0, w = 0, x = i.data.nodes.length; x > w; w++)
                                                    if (
                                                        ((y =
                                                            i.data.origin && (i.data.origin.settings.dnd.always_copy || (i.data.origin.settings.dnd.copy && (i.event.metaKey || i.event.ctrlKey)))
                                                                ? "copy_node"
                                                                : "move_node"),
                                                        (z = t),
                                                        "move_node" === y &&
                    ...
                    .on("dnd_stop.vakata.jstree", function (b, h) {
                        if ((a(".jstree-dnd-parent").removeClass("jstree-dnd-parent"), f && clearTimeout(f), h && h.data && h.data.jstree)) {
                            ...
                            if (c) {
                                ...
                                c.ins[
                                    h.data.origin && (h.data.origin.settings.dnd.always_copy || (h.data.origin.settings.dnd.copy && (h.event.metaKey || h.event.ctrlKey))) ? "copy_node" : "move_node"
                            ...
                            h &&
                                ...
                                ("keyup" === b.type && 27 === b.which
                                    ...
                                    : (h.helper
                                          .find(".jstree-copy")
                                          .first()
                                          [h.data.origin && (h.data.origin.settings.dnd.always_copy || (h.data.origin.settings.dnd.copy && (b.metaKey || b.ctrlKey))) ? "show" : "hide"](),
                        ...
                        return (
                            ...
                            e !== !1 &&
                                (c.helper = a("<div id='vakata-dnd'></div>")
                                    .html(e)
                                    .css({ display: "block", margin: "0", padding: "0", position: "absolute", top: "-2000px", lineHeight: "16px", zIndex: "10000" })),
                        ...
                        if (!e) {
                            ...
                            if (((this._data.massload = {}), h.length)) {
                                ...
                                if ("object" == typeof g && g && g.url)
                                    return (
                                        (g = a.extend(!0, {}, g)),
                                        a.vakata.is_function(g.url) && (g.url = g.url.call(this, h)),
                                        a.vakata.is_function(g.data) && (g.data = g.data.call(this, h)),
                                        a
                                            .ajax(g)
                                            .done(
                                                function (a, g, h) {
                        ...
                        if ((this._data.search.res.length && !g && this.clear_search(), e === b && (e = i.show_only_matches), h === b && (h = i.show_only_matches_children), !d && j !== !1))
                            return a.vakata.is_function(j)
                                ? j.call(
                                      ...
                                      function (b) {
                                          b && b.d && (b = b.d),
                                              this._load_nodes(a.vakata.is_array(b) ? a.vakata.array_unique(b) : [], function () {
                ...
                (this.bind = function () {
                    ...
                    (this.restore_state = function () {
                        ...
                        return b && b.ttl && b.sec && +new Date() - b.sec > b.ttl
                            ? !1
                            : (b && b.state && (b = b.state),
                              b && a.vakata.is_function(this.settings.state.filter) && (b = this.settings.state.filter.call(this, b)),
                              b
                                  ? (this.settings.state.preserve_loaded || delete b.core.loaded,
                ...
                (this.init = function (c, e) {
                    ...
                    (this._delete_ids = function (b) {
                        ...
                        return (
                            ...
                            b.children && a.vakata.is_array(b.children) && (b.children = this._delete_ids(b.children)),
                            b
                        );
                    }),
                                ...
                                if (f[i].a_attr.hasOwnProperty(k)) {
                                    ...
                                    "class" === k
                                        ...
                                        : e[c.id].a_attr[k] === f[i].a_attr[k] &&
                                          ("href" === k ? ((e[c.id].a_attr[k] = "#"), m && m.attr("href", "#")) : (delete e[c.id].a_attr[k], m && m.removeAttr(k)));
                                }
                    ...
                    (this.create_node = function (c, e, f, g, h) {
                        if (!e || e.text === b) {
                            ...
                            for (j = i = this.get_string("New node"), k = [], l = 0, m = c.children.length; m > l; l++)
                                (r = n[c.children[l]].text), o || (r = r.toLowerCase()), p && (r = r.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "")), k.push(r);
                            ...
                            .on(
                                ...
                                function (a, b) {
                                    ("hover_node" === a.type && this.is_disabled(b.node)) ||
                                        this.get_node(b.node, !0).children(".jstree-wholerow")["hover_node" === a.type ? "addClass" : "removeClass"]("jstree-wholerow-hovered");
                                }.bind(this)
                            )
                            .on(
                                "contextmenu.jstree",
