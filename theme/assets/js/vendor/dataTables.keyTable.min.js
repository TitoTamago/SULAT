...
(function (c) {
        ...
        _constructor: function () {
            ...
            if (this.c.editor) {
                ...
                c(b.table().body()).on("dblclick" + d, "th, td", function (g) {
                    !1 !== a.s.enable && b.cell(this).any() && ((a.s.lastFocus && this !== a.s.lastFocus.cell.node()) || a._editor(null, g, !0));
                });
            ...
            h.getSelection &&
                (c(k).on("copy" + e, function (d) {
                    ...
                    var f = h.getSelection().toString(),
                        p = b.s.lastFocus;
                    !f && p && (d.clipboardData.setData("text/plain", p.cell.render(b.c.clipboardOrthogonal)), d.preventDefault());
                }),
                c(k).on("paste" + e, function (d) {
                    ...
                    !p ||
                        ...
                        (f.preventDefault(),
                        h.clipboardData && h.clipboardData.getData ? (g = h.clipboardData.getData("Text")) : f.clipboardData && f.clipboardData.getData && (g = f.clipboardData.getData("text/plain")),
                        d ? ((f = b._inlineOptions(p.cell.index())), d.inline(f.cell, f.field, f.options).set(d.displayed()[0], g).submit()) : (p.cell.data(g), a.draw(!1)));
                }));
        },
        _columns: function () {
            var a = this.s.dt,
                ...
                if (-1 !== l.length && (a < l.start || a >= l.start + l.length))
                    ...
                    if (e === m || !0 === e)
                        this._scroll(c(h), c(k.body), g, "offset"),
                            ...
                            e !== p.table().header().parentNode && ((e = c(e.parentNode)), this._scroll(e, e, g, "position"));
            ...
            if (g) {
                ...
                q &&
                    ...
                    "right" === b
                        ...
                        ? g--
                        : "down" === b && g++,
                    0 <= g && g < p && -1 !== c.inArray(q, l) ? (a && a.preventDefault(), this._focus(g, q, !0, a)) : e && this.c.blurable ? this._blur() : a && a.preventDefault());
            }
        },
        _tabInput: function () {
            var a = this,
    ...
    n.ext.selector.cell.push(function (a, b, e) {
        ...
        var d = [];
        if (!a || b === m) return e;
        for (var f = 0, p = e.length; f < p; f++) ((!0 === b && a.focused(e[f])) || (!1 === b && !a.focused(e[f]))) && d.push(e[f]);
        return d;
    });
