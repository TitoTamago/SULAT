...
(jvm.$ = jQuery),
    ...
    (jvm.AbstractShapeElement.prototype.updateStyle = function () {
        ...
        jvm.AbstractShapeElement.mergeStyles(e, this.style.initial),
            ...
            this.isSelected && (jvm.AbstractShapeElement.mergeStyles(e, this.style.selected), this.isHovered && jvm.AbstractShapeElement.mergeStyles(e, this.style.selectedHover)),
            this.set(e);
    }),
    ...
    (jvm.DataSeries = function (e, t) {
        ...
        (e = e || {}),
            ...
            jvm.$.isArray(e.scale)
                ? ((n = e.attribute === "fill" || e.attribute === "stroke" ? jvm.ColorScale : jvm.NumericScale), (this.scale = new n(e.scale, e.normalizeFunction, e.min, e.max)))
                : e.scale
    ...
    (jvm.WorldMap.prototype = {
        ...
        applyTransform: function () {
            ...
            this.defaultWidth * this.scale <= this.width
                ...
                this.defaultHeight * this.scale <= this.height
                    ? ((t = (this.height - this.defaultHeight * this.scale) / (2 * this.scale)), (r = (this.height - this.defaultHeight * this.scale) / (2 * this.scale)))
                ...
                a = function (a) {
                    ...
                    a.type == "touchstart" && (u = 0),
                        f.length == 1
                            ...
                            : f.length == 2 &&
                              (u == 2
                                  ? ((c = Math.sqrt(Math.pow(f[0].pageX - f[1].pageX, 2) + Math.pow(f[0].pageY - f[1].pageY, 2)) / t), n.setScale(e * c, s, o), n.label.hide(), a.preventDefault())
                                  : ((l = jvm.$(n.container).offset()),
                                    f[0].pageX > f[1].pageX ? (s = f[1].pageX + (f[0].pageX - f[1].pageX) / 2) : (s = f[0].pageX + (f[1].pageX - f[0].pageX) / 2),
                                    f[0].pageY > f[1].pageY ? (o = f[1].pageY + (f[0].pageY - f[1].pageY) / 2) : (o = f[0].pageY + (f[1].pageY - f[0].pageY) / 2),
                                    (s -= l.left),
                                    (o -= l.top),
                                    (e = n.scale),
                ...
                this.container.delegate("[class~='jvectormap-element']", "mouseover mouseout", function (t) {
                    ...
                    t.type == "mouseover"
                        ? (e.container.trigger(f, [s]),
                          ...
                          a.isDefaultPrevented() || (e.label.show(), (e.labelWidth = e.label.width()), (e.labelHeight = e.label.height())))
        ...
        getMarkerPosition: function (e) {
            return jvm.WorldMap.maps[this.params.map].projection
                ...
                : { x: e.coords[0] * this.scale + this.transX * this.scale, y: e.coords[1] * this.scale + this.transY * this.scale };
        },
            ...
            return (
                ...
                u
                    ? ((a = u.bbox),
                      ...
                      { x: n.x + this.transX * this.scale + u.left * this.scale, y: n.y + this.transY * this.scale + u.top * this.scale })
                    : !1
            );
        },
