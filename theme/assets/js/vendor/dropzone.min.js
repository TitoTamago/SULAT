    ...
    return (function () {
        var e = {
                ...
                1285: function (e, t, n) {
                    ...
                    e.exports = function (e) {
                        for (
                            var t = r(this), n = o(t.length), a = arguments.length, u = i(a > 1 ? arguments[1] : void 0, n), s = a > 2 ? arguments[2] : void 0, l = void 0 === s ? n : i(s, n);
                            l > u;
                ...
                5417: function (e, t, n) {
                    ...
                    e.exports = function (e, t) {
                        var n;
                        return (
                            i(e) && ("function" != typeof (n = e.constructor) || (n !== Array && !i(n.prototype)) ? r(n) && null === (n = n[o]) && (n = void 0) : (n = void 0)),
                ...
                654: function (e, t, n) {
                    ...
                    e.exports = function (e, t, n, c, h, w, E) {
                        ...
                        if (
                            (U &&
                                ((k = o(U.call(new e()))),
                                d !== Object.prototype && k.next && (f || o(k) === d || (a ? a(k, d) : "function" != typeof k[y] && s(k, y, x)), u(k, T, !0, !0), f && (p[T] = x))),
                            h == m &&
                                R &&
                                R.name !== m &&
                                ((C = !0),
                    ...
                    r(
                        { target: "Array", proto: !0, forced: !f },
                        {
                            slice: function (e, t) {
                                ...
                                if (
                                    o(f) &&
                                    ("function" != typeof (n = f.constructor) || (n !== Array && !o(n.prototype)) ? i(n) && null === (n = n[p]) && (n = void 0) : (n = void 0),
                                    n === Array || void 0 === n)
                                )
                                    return h.call(f, y, g);
                                    ...
                                    "".split(/.?/).length
                                        ? function (e, n) {
                                              ...
                                              for (
                                                  ...
                                                  !(
                                                      (s = y.lastIndex) > d &&
                                                      (c.push(r.slice(d, u.index)), u.length > 1 && u.index < r.length && h.apply(c, u.slice(1)), (l = u[0].length), (d = s), c.length >= o)
                                                  );
                                ...
                                switch (((a = o[p]), c)) {
                                    ...
                                    case se:
                                        if (((e.scheme = i.scheme), a == r))
                                            (e.username = i.username), (e.password = i.password), (e.host = i.host), (e.port = i.port), (e.path = i.path.slice()), (e.query = i.query);
                                        else if ("/" == a || ("\\" == a && X(e))) c = le;
                                        else if ("?" == a)
                                            (e.username = i.username), (e.password = i.password), (e.host = i.host), (e.port = i.port), (e.path = i.path.slice()), (e.query = ""), (c = Ee);
                                        else {
                                            if ("#" != a) {
            ...
            (function () {
                    ...
                    addedfile: function (e) {
                        ...
                        if ((this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer && !this.options.disablePreviews)) {
                            ...
                            this.options.addRemoveLinks &&
                                ((e._removeLink = b.createElement('<a class="dz-remove" href="javascript:undefined;" data-dz-remove>'.concat(this.options.dictRemoveFile, "</a>"))),
                    ...
                    function i(e, t) {
                        ...
                        return (
                            ...
                            !1 !== n.options.previewsContainer &&
                                (n.options.previewsContainer ? (n.previewsContainer = i.getElement(n.options.previewsContainer, "previewsContainer")) : (n.previewsContainer = n.element)),
                        ...
                        d(
                            ...
                            [
                                            ...
                                            this.clickableElements.forEach(function (t) {
                                                return e.listeners.push({
                                                    ...
                                                    events: {
                                                        click: function (n) {
                                                            return (
                                                                (t !== e.element || n.target === e.element || i.elementInside(n.target, e.element.querySelector(".dz-message"))) &&
                                ...
                                },
                                {
                                    key: "removeFile",
                                    value: function (e) {
                                        if ((e.status === i.UPLOADING && this.cancelUpload(e), (this.files = x(this.files, e)), this.emit("removedfile", e), 0 === this.files.length))
                                    ...
                                    value: function (e) {
                                        if (e.status === i.UPLOADING) {
                                            ...
                                            (e.status !== i.ADDED && e.status !== i.QUEUED) ||
                                                ((e.status = i.CANCELED), this.emit("canceled", e), this.options.uploadMultiple && this.emit("canceledmultiple", [e]));
                ...
                b.initClass(),
                    ...
                    (b.dataURItoBlob = function (e) {
                        for (
                            var t = atob(e.split(",")[1]), n = e.split(",")[0].split(":")[1].split(";")[0], r = new ArrayBuffer(t.length), i = new Uint8Array(r), o = 0, a = t.length, u = 0 <= a;
                            u ? o <= a : o >= a;
                            u ? o++ : o--
                        )
                            i[o] = t.charCodeAt(o);
