...
!(function (t, e) {
    ...
    return (function (t) {
                ...
                return (
                    ...
                    s(e, [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                return (
                                    null == this.cache.length && (this.cache.length = u(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "length", this).call(this) + 1), this.cache.length
                                );
                            },
                        },
                        {
            ...
            function s(t, e) {
                function n(t, e, n) {
                    for (var r, o, i, s, u = t.substring(n, n + Math.floor(t.length / 4)), c = -1, f = ""; -1 != (c = e.indexOf(u, c + 1)); ) {
                        ...
                        f.length < p + h &&
                            ((f = e.substring(c - p, c) + e.substring(c, c + h)), (r = t.substring(0, n - p)), (o = t.substring(n + h)), (i = e.substring(0, c - p)), (s = e.substring(c + h)));
                    }
        ...
        function (t, e) {
            ...
            function r(t) {
                return (
                    (t && "object" == typeof t && "number" == typeof t.length && Object.prototype.hasOwnProperty.call(t, "callee") && !Object.prototype.propertyIsEnumerable.call(t, "callee")) || !1
                );
            }
            var o =
                "[object Arguments]" ==
                        ...
                        a(e, [
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    ...
                                    this.cachedText !== e &&
                                        ((e.trim().length > 0 || null == this.cachedText) && ((this.domNode.innerHTML = t(e)), this.domNode.normalize(), this.attach()), (this.cachedText = e));
                                },
                            },
                        ]),
                        e
