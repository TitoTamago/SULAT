...
!(function (a, b) {
                ...
                b.mixin(c.prototype, {
                    ...
                    _get: function (a, b) {
                        ...
                        (i = this._fingerprint(a)),
                            this.cancelled ||
                                i !== this.lastReq ||
                                ((j = f[i]) ? j.done(c).fail(e) : g > d ? (d++, (f[i] = this._send(a).done(c).fail(e).always(h))) : (this.onDeckRequestArgs = [].slice.call(arguments, 0)));
                    },
                    get: function (c, d) {
                        var e, f;
                        (d = d || a.noop),
    ...
    (function (a, b) {
        ...
        !(function () {
            ...
            function h(a, b) {
                a.data(p.attrs, { dir: a.attr("dir"), autocomplete: a.attr("autocomplete"), spellcheck: a.attr("spellcheck"), style: a.attr("style") }),
