...
!(function (t, n) {
    ...
    function F(t, n) {
        ...
        function l(l) {
            ...
            (m = m.merge(m.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "currentColor"))),
                ...
                m.attr(
                    "d",
                    t === q || t == R ? (a ? "M" + c * a + "," + g + "H0.5V" + y + "H" + c * a : "M0.5," + g + "V" + y) : a ? "M" + g + "," + c * a + "V0.5H" + y + "V" + c * a : "M" + g + ",0.5H" + y
                ),
    ...
    function W(t) {
        var n = (t += ""),
            e = n.indexOf(":");
        return e >= 0 && "xmlns" !== (n = t.slice(0, e)) && (t = t.slice(e + 1)), $.hasOwnProperty(n) ? { space: $[n], local: t } : t;
    }
    function Z(t) {
        var n = W(t);
        return (
            ...
            if (c)
                for (var s = 0, l = c.length; s < l; ++s)
                    if ((u = c[s]).type === t.type && u.name === t.name)
                        return this.removeEventListener(u.type, u.listener, u.capture), this.addEventListener(u.type, (u.listener = f), (u.capture = e)), void (u.value = n);
            ...
            (n = rn.exec(t))
                ? ((e = n[1].length),
                  ...
                  6 === e
                      ...
                      : 4 === e
                      ? gn(((n >> 12) & 15) | ((n >> 8) & 240), ((n >> 8) & 15) | ((n >> 4) & 240), ((n >> 4) & 15) | (240 & n), (((15 & n) << 4) | (15 & n)) / 255)
                      : null)
                : (n = on.exec(t))
    ...
    function Nn(t) {
        ...
        var n = (t = t.rgb()).r / 255,
            ...
            c = (o + i) / 2;
        return (
            u ? ((a = n === o ? (e - r) / u + 6 * (e < r) : e === o ? (r - n) / u + 2 : (n - e) / u + 4), (u /= c < 0.5 ? o + i : 2 - o - i), (a *= 60)) : (u = c > 0 && c < 1 ? 0 : a),
    ...
    Qt(Jt, pn, {
        ...
        Qt(
            ...
            Kt(Jt, {
                brighter: function (t) {
                    return (t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t)), new bn(this.r * t, this.g * t, this.b * t, this.opacity);
                },
                darker: function (t) {
    ...
    function Un(t) {
        ...
        return (
            r === i && i === o ? (n = e = a) : ((n = Fn((0.4360747 * r + 0.3850649 * i + 0.1430804 * o) / Cn)), (e = Fn((0.0139322 * r + 0.0971045 * i + 0.7141733 * o) / zn))),
    ...
    function Ne(t, n) {
        ...
        for (t += "", n += ""; (e = we.exec(t)) && (r = Me.exec(n)); )
            (i = r.index) > o && ((i = n.slice(o, i)), u[a] ? (u[a] += i) : (u[++a] = i)),
                (e = e[0]) === (r = r[0]) ? (u[a] ? (u[a] += r) : (u[++a] = r)) : ((u[++a] = null), c.push({ i: a, x: me(e, r) })),
                (o = Me.lastIndex);
        return (
    ...
    function De(t, n, e, r) {
        ...
        return function (o, a) {
            ...
            return (
                ...
                (function (t, n, e, o) {
                    t !== n ? (t - n > 180 ? (n += 360) : n - t > 180 && (t += 360), o.push({ i: e.push(i(e) + "rotate(", null, r) - 2, x: me(t, n) })) : n && e.push(i(e) + "rotate(" + n + r);
                })(o.rotate, a.rotate, u, c),
                (function (t, n, e, o) {
                    t !== n ? o.push({ i: e.push(i(e) + "skewX(", null, r) - 2, x: me(t, n) }) : n && e.push(i(e) + "skewX(" + n + r);
                })(o.skewX, a.skewX, u, c),
    ...
    function gr(t) {
        tr ||
            ...
            t - or > 24 ? (t < 1 / 0 && (nr = setTimeout(pr, t - ur.now() - ar)), er && (er = clearInterval(er))) : (er || ((ir = ur.now()), (er = setInterval(vr, rr))), (tr = 1), cr(pr)));
    }
    function yr(t, n, e) {
        var r = new lr();
        return (
    ...
    function Sr(t, n, e, r, i, o) {
                ...
                for (f in i)
                    if ((h = i[f]).name === e.name) {
                        ...
                        h.state === Nr
                            ...
                            : +f < n && ((h.state = Ar), h.timer.stop(), h.on.call("cancel", t, t.__data__, h.index, h.group), delete i[f]);
                    }
                if (
                    (yr(function () {
        ...
        })(t, e, { name: n, index: r, group: i, on: _r, tween: br, time: o.time, delay: o.delay, duration: o.duration, ease: o.ease, timer: null, state: mr });
    }
    function kr(t, n) {
        var e = Cr(t, n);
    ...
    function Pr(t, n) {
        ...
        if (o) {
            for (i in ((n = null == n ? null : n + ""), o))
                (e = o[i]).name === n
                    ? ((r = e.state > wr && e.state < Tr), (e.state = Ar), e.timer.stop(), e.on.call(r ? "interrupt" : "cancel", t, t.__data__, e.index, e.group), delete o[i])
                    : (a = !1);
                        ...
                        F.on(
                            ...
                            function () {
                                switch (t.event.keyCode) {
                                    ...
                                    case 32:
                                        (x !== Ni && x !== Ti) ||
                                            (w < 0 ? (f = h - P) : w > 0 && (r = o - P), M < 0 ? (d = p - z) : M > 0 && (u = c - z), (x = Mi), B.attr("cursor", Pi.selection), I());
                                        break;
                                    default:
                                        return;
                                }
            ...
            function I() {
                ...
                switch (((P = L[0] - q[0]), (z = L[1] - q[1]), x)) {
                    ...
                    case wi:
                        ...
                        break;
                    case Ni:
                        w < 0 ? ((P = Math.max(S - r, Math.min(E - r, P))), (o = r + P), (h = f)) : w > 0 && ((P = Math.max(S - f, Math.min(E - f, P))), (o = r), (h = f + P)),
                            M < 0 ? ((z = Math.max(k - u, Math.min(C - u, z))), (c = u + z), (p = d)) : M > 0 && ((z = Math.max(k - d, Math.min(C - d, z))), (c = u), (p = d + z));
                        break;
                    case Ti:
                ...
                h < o && ((w *= -1), (t = r), (r = f), (f = t), (t = o), (o = h), (h = t), m in zi && B.attr("cursor", Pi[(m = zi[m])])),
                    p < c && ((M *= -1), (t = u), (u = d), (d = t), (t = c), (c = p), (p = t), m in Ri && B.attr("cursor", Pi[(m = Ri[m])])),
            ...
            null === this._x1 ? (this._ += "M" + c + "," + f) : (Math.abs(this._x1 - c) > 1e-6 || Math.abs(this._y1 - f) > 1e-6) && (this._ += "L" + c + "," + f),
                e &&
                    ...
                    l > Ji
                        ...
                        : l > 1e-6 && (this._ += "A" + e + "," + e + ",0," + +(l >= Qi) + "," + s + "," + (this._x1 = t + e * Math.cos(i)) + "," + (this._y1 = n + e * Math.sin(i))));
        },
    ...
    function Oa(t) {
        ...
        var n;
        return new Ba({ fill: n[1], align: n[2], sign: n[3], symbol: n[4], zero: n[5], width: n[6], comma: n[7], precision: n[8] && n[8].slice(1), trim: n[9], type: n[10] });
    }
    function Ba(t) {
            ...
            var o,
                ...
                h = {
                    ...
                    polygonEnd: function () {
                        ...
                        var t = ff(o, r);
                        a.length ? (l || (i.polygonStart(), (l = !0)), of(a, hf, t, e, i)) : t && (l || (i.polygonStart(), (l = !0)), i.lineStart(), e(null, null, 1, i), i.lineEnd()),
                            l && (i.polygonEnd(), (l = !1)),
                            (a = o = null);
                    },
                    sphere: function () {
            ...
            return {
                ...
                point: function (o, a) {
                    var u = o > 0 ? ru : -ru,
                        c = fu(o - e);
                    fu(c - ru) < nu
                        ? (t.point(e, (r = (r + a) / 2 > 0 ? iu : -iu)), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(u, r), t.point(o, r), (n = 0))
                        : i !== u &&
                          c >= ru &&
                          (fu(e - i) < nu && (e -= i * nu),
                          fu(o - u) < nu && (o -= u * nu),
        ...
        function a(t, e, r) {
            ...
            if (!(g < 0)) {
                ...
                var N = x - m,
                    T = fu(N - ru) < nu;
                if (
                    (!T && M < w && ((b = w), (w = M), (M = b)), T || N < nu ? (T ? (w + M > 0) ^ (_[1] < (fu(_[0] - m) < nu ? w : M)) : w <= _[1] && _[1] <= M) : (N > ru) ^ (m <= _[0] && _[0] <= x))
                ) {
                    var A = $u(d, (-p + y) / v);
            ...
            function (t) {
                ...
                return {
                    ...
                    point: function (l, h) {
                        ...
                        if ((!n && (f = c = v) && t.lineStart(), v !== c && (!(d = a(n, p)) || ef(n, d) || ef(p, d)) && ((p[0] += nu), (p[1] += nu), (v = o(p[0], p[1]))), v !== c))
                  ...
                  function e(r, i, o, a, u, c, f, s, l, h, d, p, v, g) {
                      ...
                      if (b > 4 * n && v--) {
                          ...
                          ((P * P) / b > n || fu((y * E + _ * C) / b - 0.5) > 0.3 || a * h + u * d + c * p < Gs) &&
                              (e(r, i, o, a, u, c, S, k, T, (m /= M), (x /= M), w, v, g), g.point(S, k), e(S, k, T, m, x, w, f, s, l, h, d, p, v, g));
                      }
                  }
                  return function (n) {
                      var r,
    ...
    function Ks(t) {
        ...
        return (
            ...
            (S.clipExtent = function (t) {
                return arguments.length
                    ? ((T = null == t ? ((N = r = i = o = null), Yf) : yf((N = +t[0][0]), (r = +t[0][1]), (i = +t[1][0]), (o = +t[1][1]))), C())
                    : null == N
                    ? null
                    : [
                          [N, r],
    ...
    (_l.invert = function (t, n) {
        for (
            ...
            a < 12 && ((o = (i = (r -= e = (r * (dl + pl * i + o * (vl + gl * i)) - n) / (dl + 3 * pl * i + o * (7 * vl + 9 * gl * i))) * r) * i * i), !(fu(e) < eu));
            ++a
        );
    ...
    function ql(t, n) {
        ...
        for (e = 0; e < t.length - 1; ++e)
            for (r = e + 1; r < t.length; ++r) if (Ll(Fl(t[e], t[r]), n) && Ll(Fl(t[e], n), t[r]) && Ll(Fl(t[r], n), t[e]) && Ol(Yl(t[e], t[r], n), t)) return [t[e], t[r], n];
        throw new Error();
    }
    function Ll(t, n) {
        var e = t.r - n.r,
    ...
    function gh(t, n, e, r, i, o) {
        for (var a, u, c, f, s, l, h, d, p, v, g, y = [], _ = n.children, b = 0, m = 0, x = _.length, w = n.value; b < x; ) {
            ...
            y.push((a = { value: s, dice: c < f, children: _.slice(b, m) })), a.dice ? eh(a, e, r, i, w ? (r += (f * s) / w) : o) : ph(a, e, r, w ? (e += (c * s) / w) : i, o), (w -= s), (b = m);
        }
        return y;
    }
    var yh = (function t(n) {
        ...
        function w(t, n) {
            return function (e) {
                ...
                for (e instanceof Date || (e = new Date(+e)); ++u < f; )
                    37 === t.charCodeAt(u) &&
                        (a.push(t.slice(c, u)), null != (i = xp[(r = t.charAt(++u))]) ? (r = t.charAt(++u)) : (i = "e" === r ? " " : "0"), (o = n[r]) && (r = o(e, i)), a.push(r), (c = u + 1));
    ...
    function Oy(t, n, e, r, i, o, a) {
        var u = t - e,
            ...
            C = A - g,
            P = S - y;
        return k * k + E * E > C * C + P * P && ((N = A), (T = S)), { cx: N, cy: T, x01: -s, y01: -l, x11: N * (i / x - 1), y11: T * (i / x - 1) };
    }
    function By(t) {
        this._context = t;
    }
        ...
        (J_.prototype = {
            ...
            lineEnd: function () {
                ...
                if (e)
                    ...
                    else for (var r = tb(t), i = tb(n), o = 0, a = 1; a < e; ++o, ++a) this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[a], n[a]);
        ...
        (hb.prototype = {
            ...
            remove: function (t) {
                ...
                if (
                    ...
                    o && a
                        ? ((r = e.C), (e.C = t.C), (e.L = o), (o.U = e), e !== a ? ((i = e.U), (e.U = t.U), (t = e.R), (i.L = t), (e.R = a), (a.U = e)) : ((e.U = i), (i = e), (t = e.R)))
                        : ((r = t.C), (t = e)),
                    t && (t.U = i),
                    !r)
                )
                ...
                this.cells.forEach(function (e, r) {
                    if ((o = (i = e.halfedges).length))
                        for (var i, o, a, u = e.site, c = -1, f = n[i[o - 1]], s = f.left === u ? f.right : f.left; ++c < o; )
                            (a = s), (s = (f = n[i[c]]).left === u ? f.right : f.left), a && s && r < a.index && r < s.index && jb(u, a, s) < 0 && t.push([u.data, a.data, s.data]);
                }),
                t
            );
        },
    ...
    (Qb.prototype = Wb.prototype),
        ...
        (t.forceManyBody = function () {
            ...
            function l(t, i, c, f) {
                ...
                if ((h * h) / u < d)
                    return (
                        d < a &&
                            (0 === s && (d += (s = ya()) * s), 0 === l && (d += (l = ya()) * l), d < o && (d = Math.sqrt(o * d)), (n.vx += (s * t.value * e) / d), (n.vy += (l * t.value * e) / d)),
                        !0
                    );
                if (!(t.length || d >= a)) {
        ...
        (t.geoCircle = function () {
            ...
            function a() {
                ...
                return (t = []), (n = $c(-a[0] * cu, -a[1] * cu, 0).invert), Jc(o, u, c, 1), (a = { type: "Polygon", coordinates: [t] }), (t = n = null), a;
            }
            return (
                (a.center = function (t) {
        ...
        (t.geoIdentity = function () {
            ...
            return (
                ...
                (b.clipExtent = function (t) {
                    return arguments.length
                        ? ((y = null == t ? ((d = e = r = i = null), Yf) : yf((d = +t[0][0]), (e = +t[0][1]), (r = +t[1][0]), (i = +t[1][1]))), _())
                        : null == d
                        ? null
                        : [
                              [d, e],
        ...
        (t.interpolateSinebow = function (t) {
            var n;
            return (t = (0.5 - t) * Math.PI), (hy.r = 255 * (n = Math.sin(t)) * n), (hy.g = 255 * (n = Math.sin(t + dy)) * n), (hy.b = 255 * (n = Math.sin(t + py)) * n), hy + "";
        }),
        ...
        (t.tree = function () {
            ...
            function i(i) {
                var c = (function (t) {
                    for (var n, e, r, i, o, a = new dh(t, 0), u = [a]; (n = u.pop()); )
                        if ((r = n._.children)) for (n.children = new Array((o = r.length)), i = o - 1; i >= 0; --i) u.push((e = n.children[i] = new dh(r[i], i))), (e.parent = n);
            ...
            function o(n) {
                ...
                n.parent.A = (function (n, e, r) {
                    if (e) {
                        for (var i, o = n, a = n, u = e, c = o.parent.children[0], f = o.m, s = a.m, l = u.m, h = c.m; (u = sh(u)), (o = fh(o)), u && o; )
                            (c = fh(c)), ((a = sh(a)).a = n), (i = u.z + l - o.z - f + t(u._, o._)) > 0 && (lh(hh(u, n, r), n, i), (f += i), (s += i)), (l += u.m), (f += o.m), (h += c.m), (s += a.m);
                ...
                if (r.apply(this, arguments)) {
                    ...
                    for (Kb(), i = 0; i < c; ++i)
                        (a = [(a = Ft(this, u, (o = u[i]).identifier)), this.__zoom.invert(a), o.identifier]),
                            f.touch0 ? f.touch1 || f.touch0[2] === a[2] || ((f.touch1 = a), (f.taps = 0)) : ((f.touch0 = a), (e = !0), (f.taps = 1 + !!n));
                    n && (n = clearTimeout(n)),
                        e &&
                            (f.taps < 2 &&
