...
!(function (t, e) {
    ...
    function k(t) {
        ...
        let r, l, h;
        return (
            n !== o && ((h = n - o), (l = a > 0.5 ? h / (2 - n - o) : h / (n + o)), (r = n === e ? (i - s) / h + (i < s ? 6 : 0) : n === i ? (s - e) / h + 2 : (e - i) / h + 4), (r = 60 * r + 0.5)),
            [0 | r, l || 0, a]
        );
    }
    function S(t, e, i, s) {
    ...
    class F {
                ...
                : "string" === e &&
                  ...
                  "#" === s[0] &&
                      (4 === o || 5 === o
                          ...
                          : (7 !== o && 9 !== o) || (n = { r: (r[s[1]] << 4) | r[s[2]], g: (r[s[3]] << 4) | r[s[4]], b: (r[s[5]] << 4) | r[s[6]], a: 9 === o ? (r[s[7]] << 4) | r[s[8]] : 255 })),
                  (i = n || L(t) || z(t))),
                (this._rgb = i),
                (this._valid = !!i);
        }
        ...
        mix(t, e) {
            ...
            if (t) {
                ...
                (o = 1 - h), (s.r = 255 & (h * s.r + o * n.r + 0.5)), (s.g = 255 & (h * s.g + o * n.g + 0.5)), (s.b = 255 & (h * s.b + o * n.b + 0.5)), (s.a = a * s.a + (1 - a) * n.a), (i.rgb = s);
            }
            return i;
        }
        clone() {
    ...
    function Xt(t, e, i, s) {
        ...
        for (l = 0; l < r; l++)
            ...
            else if (Y(d)) for (h = 0, c = d.length; h < c; h++) (u = d[h]), null == u || Y(u) || (a = Ut(t, n, o, a, u));
        t.restore();
        const f = o.length / 2;
        if (f > i.length) {
    ...
    function We(t, e) {
        ...
        const n = { family: K(t.family, e.family), lineHeight: Ie(K(t.lineHeight, e.lineHeight), i), size: i, style: s, weight: K(t.weight, e.weight), string: "" };
    ...
    function si(t, e = [""], i = t, s, n = () => t[0]) {
        ...
        const o = { [Symbol.toStringTag]: "Object", _cacheable: !0, _scopes: t, _rootScopes: i, _fallback: s, _getTarget: n, override: (n) => si([n, ...t], e, i, s) };
        return new Proxy(o, {
    ...
    function ni(t, e, i, s) {
        const n = { _cacheable: !1, _proxy: t, _context: e, _subProxy: i, _stack: new Set(), _descriptors: oi(t, s), setContext: (e) => ni(t, e, i, s), override: (n) => ni(t.override(n), e, i, s) };
        return new Proxy(n, {
            ...
            for (let c = 0; c < s - 1; ++c)
                (l = h),
                    ...
                    l &&
                        ...
                        (Tt(e[c], 0, mi)
                            ? (i[c] = i[c + 1] = 0)
                            : ((n = i[c] / e[c]), (o = i[c + 1] / e[c]), (r = Math.pow(n, 2) + Math.pow(o, 2)), r <= 9 || ((a = 3 / Math.sqrt(r)), (i[c] = n * a * e[c]), (i[c + 1] = o * a * e[c]))));
        })(t, n, o),
            (function (t, e, i = "x") {
                const s = bi(i),
                    n = t.length;
    ...
    function wi(t, e, i, s, n) {
        ...
        if ((e.spanGaps && (t = t.filter((t) => !t.skip)), "monotone" === e.cubicInterpolationMode)) yi(t, n);
            ...
            for (o = 0, a = t.length; o < a; ++o)
                (r = t[o]), (l = _i(i, r, t[Math.min(o + 1, a - (s ? 0 : 1)) % a], e.tension)), (r.cp1x = l.previous.x), (r.cp1y = l.previous.y), (r.cp2x = l.next.x), (r.cp2y = l.next.y), (i = r);
        }
        e.capBezierPoints &&
            (function (t, e) {
                let i,
                ...
                for (i = 0, s = t.length; i < s; ++i)
                    (a = o),
                        ...
                        o &&
                            ((n = t[i]),
                            a && ((n.cp1x = vi(n.cp1x, e.left, e.right)), (n.cp1y = vi(n.cp1y, e.top, e.bottom))),
                            r && ((n.cp2x = vi(n.cp2x, e.left, e.right)), (n.cp2y = vi(n.cp2y, e.top, e.bottom))));
            })(t, i);
    }
    const Mi = (t) => 0 === t || 1 === t,
        ...
        Pi = {
            ...
            easeInOutExpo: (t) => (Mi(t) ? t : t < 0.5 ? 0.5 * Math.pow(2, 10 * (2 * t - 1)) : 0.5 * (2 - Math.pow(2, -10 * (2 * t - 1)))),
            ...
            easeInOutElastic(t) {
                const e = 0.1125;
                return Mi(t) ? t : t < 0.5 ? 0.5 * ki(2 * t, e, 0.45) : 0.5 + 0.5 * Si(2 * t - 1, e, 0.45);
            },
            easeInBack(t) {
                const e = 1.70158;
                return t * t * ((e + 1) * t - e);
            ...
            easeInOutBounce: (t) => (t < 0.5 ? 0.5 * Pi.easeInBounce(2 * t) : 0.5 * Pi.easeOutBounce(2 * t - 1) + 0.5),
        };
    function Di(t, e, i, s) {
    ...
    function Ri(t, e) {
        let i, s;
        ("ltr" !== e && "rtl" !== e) ||
            ((i = t.canvas.style), (s = [i.getPropertyValue("direction"), i.getPropertyPriority("direction")]), i.setProperty("direction", e, "important"), (t.prevTextDirection = s));
    }
    function Ei(t, e) {
        void 0 !== e && (delete t.prevTextDirection, t.canvas.style.setProperty("direction", e[0], e[1]));
    }
    function Ii(t) {
        return "angle" === t ? { between: Nt, compare: Vt, normalize: Wt } : { between: $t, compare: (t, e) => t - e, normalize: (t) => t };
    }
            ...
            (m = e[t % a]),
                m.skip ||
                    ...
                    p !== x &&
                        ...
                        null !== _ && v() && (g.push(zi({ start: _, end: t, loop: u, count: a, style: f })), (_ = null)),
                        (i = t),
                        (x = p)));
        ...
        return s && s.setContext && i
            ? (function (t, e, i, s) {
                  ...
                  for (const t of e) {
                      ...
                      for (u = d + 1; u <= t.end; u++) {
                          const r = i[u % l];
                          (e = Ni(s.setContext(je(n, { type: "segment", p0: o, p1: r, p0DataIndex: (u - 1) % l, p1DataIndex: u % l, datasetIndex: a })))),
    ...
    var rs = Object.freeze({ __proto__: null, _detectPlatform: as, BasePlatform: $i, BasicPlatform: Yi, DomPlatform: os });
    ...
    class ks {
        ...
        _update(t) {
            ...
            this.update(t || "default"),
                (e._clip = (function (t) {
                    let e, i, s, n;
                    return U(t) ? ((e = t.top), (i = t.right), (s = t.bottom), (n = t.left)) : (e = i = s = n = t), { top: e, right: i, bottom: s, left: n, disabled: !1 === t };
                })(
                    K(
                        this.options.clip,
                        (function (t, e, i) {
            ...
            if (t >= 0 && t < this._cachedMeta.data.length) {
                ...
                (n =
                    ...
                    (e.$context = (function (t, e, i) {
                        return je(t, { active: !1, dataIndex: e, parsed: void 0, raw: void 0, element: i, index: e, mode: "default", type: "data" });
                    })(this.getContext(), t, e))),
    ...
    class zs extends Ss {
        ...
        update(t, e, i) {
            ...
            this.beforeUpdate(),
                ...
                this._dataLimitsCached || (this.beforeDataLimits(), this.determineDataLimits(), this.afterDataLimits(), (this._range = He(this, n, s)), (this._dataLimitsCached = !0)),
            ...
            this._convertTicksToLabels(r ? Ts(this.ticks, a) : this.ticks),
                ...
                o.display && (o.autoSkip || "auto" === o.source) && ((this.ticks = Cs(this, this.ticks)), (this._labelSizes = null)),
        ...
        calculateLabelRotation() {
            ...
            (o = t.offset ? this.maxWidth / i : u / (i - 1)),
                c + 6 > o &&
                    ...
                    (a = this.maxHeight - Rs(t.grid) - e.padding - Es(t.title, this.chart.options.font)),
                    (r = Math.sqrt(c * c + d * d)),
            ...
            if (e.display)
                for (n = 0, o = s.length; n < o; ++n) {
                    ...
                    e.drawOnChartArea && a({ x: t.x1, y: t.y1 }, { x: t.x2, y: t.y2 }, t),
                        e.drawTicks &&
                            a({ x: t.tx1, y: t.ty1 }, { x: t.tx2, y: t.ty2 }, { color: t.tickColor, width: t.tickWidth, borderDash: t.tickBorderDash, borderDashOffset: t.tickBorderDashOffset });
                }
        }
        drawBorder() {
            const {
            ...
            let r, l, h, c;
            this.isHorizontal()
                ? ((r = qt(t, this.left, n) - n / 2), (l = qt(t, this.right, o) + o / 2), (h = c = a))
                : ((h = qt(t, this.top, n) - n / 2), (c = qt(t, this.bottom, o) + o / 2), (r = l = a)),
                e.save(),
        ...
        drawTitle() {
            ...
            ie(t, i.text, 0, 0, o, { color: i.color, maxWidth: d, rotation: u, textAlign: Is(r, e, s), textBaseline: "middle", translation: [h, c] });
        }
        draw(t) {
    ...
    class hn {
        constructor(t, e) {
            ...
            (this.id = j()),
                ...
                (an[this.id] = this),
                l && h
                    ? (a.listen(this, "complete", sn), a.listen(this, "progress", nn), this._initialize(), this.attached && this.update())
        ...
        _resize(t, e) {
            ...
            (this.width = o.width),
                ...
                (this._aspectRatio = this.aspectRatio),
                Me(this, a, !0) && (this.notifyPlugins("resize", { size: o }), Q(i.onResize, [this, o], this), this.attached && this._doResize(r) && this.render());
        }
        ensureScalesHaveIDs() {
        ...
        buildOrUpdateControllers() {
            ...
            for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
                ...
                if (
                    ...
                    Object.assign(e.prototype, { dataElementType: Bs.getElement(a), datasetElementType: s && Bs.getElement(s) }), (n.controller = new e(this, i)), t.push(n.controller);
                }
            }
        ...
        destroy() {
            ...
            this._stop(),
                ...
                t && (this.unbindEvents(), Kt(t, e), this.platform.releaseContext(e), (this.canvas = null), (this.ctx = null)),
    ...
    function _n(t, e, i, s) {
        ...
        "middle" === n && i && ((t.enableBorderRadius = !0), (i._top || 0) === s ? (n = h) : (i._bottom || 0) === s ? (n = c) : ((o[yn(c, a, r, l)] = !0), (n = h))),
            (o[yn(n, a, r, l)] = !0),
            (t.borderSkipped = o);
    }
    function yn(t, e, i, s) {
                    ...
                    l =
                        "flex" === s.barThickness
                            ...
                            : (function (t, e, i, s) {
                                  ...
                                  let o, a;
                                  return $(n) ? ((o = e.min * i.categoryPercentage), (a = i.barPercentage)) : ((o = n * s), (a = 1)), { chunk: o / s, ratio: a, start: e.pixels[t] - o / 2 };
                              })(t, e, s, i),
    ...
    (Mn.id = "bar"),
        ...
        (Mn.overrides = { scales: { _index_: { type: "category", offset: !0, grid: { offset: !0 } }, _value_: { type: "linear", beginAtZero: !0 } } });
    class kn extends ks {
        initialize() {
            (this.enableOptionSharing = !0), super.initialize();
        }
    ...
    (kn.id = "bubble"),
        (kn.defaults = { datasetElementType: !1, dataElementType: "point", animations: { numbers: { type: "number", properties: ["x", "y", "borderWidth", "radius"] } } }),
        (kn.overrides = { scales: { x: { type: "linear" }, y: { type: "linear" } }, plugins: { tooltip: { callbacks: { title: () => "" } } } });
    class Sn extends ks {
        constructor(t, e) {
    ...
    (Sn.id = "doughnut"),
        ...
        (Sn.descriptors = { _scriptable: (t) => "spacing" !== t, _indexable: (t) => "spacing" !== t }),
        (Sn.overrides = {
            aspectRatio: 1,
            plugins: {
                legend: {
        ...
        update(t) {
            ...
            let { start: a, count: r } = (function (t, e, i) {
                ...
                if (t._sorted) {
                    ...
                    d && (n = Ht(Math.min(ae(r, a.axis, h).lo, i ? s : ae(e, l, a.getPixelForValue(h)).lo), 0, s - 1)),
                        (o = u ? Ht(Math.max(ae(r, a.axis, c).hi + 1, i ? 0 : ae(e, l, a.getPixelForValue(c)).hi + 1), n, s) - n : s - n);
                }
    ...
    (Pn.id = "line"),
        (Pn.defaults = { datasetElementType: "line", dataElementType: "point", showLine: !0, spanGaps: !1 }),
    ...
    (On.id = "radar"),
        (On.defaults = { datasetElementType: "line", dataElementType: "point", indexAxis: "r", showLine: !0, elements: { line: { fill: "start" } } }),
    ...
    function In(t, e, i, s, n) {
        ...
        const g = (f - Math.max(0.001, f * c - i / bt) / c) / 2,
            p = r + g + u,
            m = n - g - u,
            { outerStart: x, outerEnd: b, innerStart: _, innerEnd: y } = Rn(e, d, c, m - p),
            v = c - x,
            w = c - b,
            M = p + x / v,
            k = m - b / w,
    ...
    class Fn extends Ss {
        ...
        draw(t) {
            const { options: e, circumference: i } = this,
                s = (e.offset || 0) / 2,
                n = (e.spacing || 0) / 2;
            if (((this.pixelMargin = "inner" === e.borderAlign ? 0.33 : 0), (this.fullCircles = i > _t ? Math.floor(i / _t) : 0), 0 === i || this.innerRadius < 0 || this.outerRadius < 0)) return;
            t.save();
            let o = 0;
            if (s) {
                o = s / 2;
    ...
    (Fn.id = "arc"),
        (Fn.defaults = { borderAlign: "center", borderColor: "#fff", borderRadius: 0, borderWidth: 2, offset: 0, spacing: 0, angle: void 0 }),
        ...
        $n && !e.options.segment
            ...
            : (function (t, e, i, s) {
                  const { segments: n, options: o } = e,
                      a = jn(e);
                  for (const r of n) Bn(t, o, r.style), t.beginPath(), a(t, e, r, { start: i, end: i + s - 1 }) && t.closePath(), t.stroke();
              })(t, e, i, s);
    }
    class Un extends Ss {
        constructor(t) {
    ...
    (Un.id = "line"),
        ...
        (Un.defaultRoutes = { backgroundColor: "backgroundColor", borderColor: "borderColor" }),
    ...
    class qn extends Ss {
        ...
        draw(t, e) {
            ...
            this.skip ||
                ...
                ((t.strokeStyle = i.borderColor), (t.lineWidth = i.borderWidth), (t.fillStyle = i.backgroundColor), Gt(t, i, this.x, this.y));
        }
        getRange() {
            const t = this.options || {};
    ...
    function Kn(t, e) {
        ...
        let r, l, h, c, d;
        return (
            t.horizontal ? ((d = a / 2), (r = Math.min(i, n)), (l = Math.max(i, n)), (h = s - d), (c = s + d)) : ((d = o / 2), (r = i - d), (l = i + d), (h = Math.min(s, n)), (c = Math.max(s, n))),
        ...
        const e = Kn(t),
            ...
            n = (function (t, e, i) {
                const s = t.options.borderWidth,
                    n = t.borderSkipped,
                    o = Fe(s);
                return { t: Gn(n.top, o.top, 0, i), r: Gn(n.right, o.right, 0, e), b: Gn(n.bottom, o.bottom, 0, i), l: Gn(n.left, o.left, 0, e) };
            })(t, i / 2, s / 2),
            o = (function (t, e, i) {
    ...
    class eo extends Ss {
        ...
        draw(t) {
            ...
            var r;
            t.save(),
                (o.w === n.w && o.h === n.h) || (t.beginPath(), a(t, to(o, e, n)), t.clip(), a(t, to(n, -e, o)), (t.fillStyle = i), t.fill("evenodd")),
                t.beginPath(),
                a(t, to(n, e)),
                (t.fillStyle = s),
                t.fill(),
    ...
    (eo.id = "bar"),
        (eo.defaults = { borderSkipped: "start", borderWidth: 0, borderRadius: 0, inflateAmount: "auto", pointStyle: void 0 }),
        ...
        beforeElementsUpdate: (t, e, i) => {
            ...
            t.data.datasets.forEach((e, n) => {
                ...
                let { start: c, count: d } = (function (t, e) {
                    ...
                    return l && (n = Ht(ae(e, o.axis, a).lo, 0, i - 1)), (s = h ? Ht(ae(e, o.axis, r).hi + 1, n, i) - n : i - n), { start: n, count: s };
                })(r, l);
        ...
        return (t.scale || {}).getPointPositionForValue
            ? (function (t) {
                  ...
                  if (((c = "start" === i ? a : "end" === i ? r : U(i) ? i.value : e.getBaseValue()), s.grid.circular))
                      return (h = e.getPointPositionForValue(0, a)), new ro({ x: h.x, y: h.y, radius: e.getDistanceFromCenterForValue(c) });
    ...
    function go(t, e) {
        ...
        return (
            ...
            i.length ? new Un({ points: i, options: { tension: 0 }, _loop: s, _fullLoop: s }) : null
        );
    }
    function po(t, e, i) {
        let s = t[e].fill;
    ...
    function wo(t, e, i) {
        ...
        s &&
            ...
            (function (t, e) {
                ...
                t.save(),
                    "x" === l && o !== n && (mo(t, s, a.top), vo(t, { line: i, target: s, color: n, scale: r, property: l }), t.restore(), t.save(), mo(t, s, a.bottom)),
            ...
            for (a = 0; a < s; ++a)
                (o = t.getDatasetMeta(a)),
                    ...
                    r &&
                        r.options &&
                        r instanceof Un &&
                        (l = { visible: t.isDatasetVisible(a), index: a, fill: ao(r, a, s), chart: t, axis: o.controller.options.indexAxis, scale: o.vScale, line: r }),
                    (o.$filler = l),
                    n.push(l);
    ...
    class So extends Ss {
        ...
        adjustHitBoxes() {
            ...
            if (this.isHorizontal()) {
                ...
                for (const l of e)
                    o !== l.row && ((o = l.row), (r = n(i, this.left + s, this.right - this.lineWidths[o]))), (l.top += this.top + t + s), (l.left = a.leftForLtr(a.x(r), l.width)), (r += l.width + s);
            } else {
                let o = 0,
        ...
        _draw() {
            ...
            (p = _ ? { x: n(a, this.left + u, this.right - i[0]), y: this.top + u + y, line: 0 } : { x: this.left + u, y: n(a, this.top + y + u, this.bottom - e[0].height), line: 0 }),
                ...
                !(function (t, e, i) {
                    ...
                    if (
                        ...
                        const o = e + Math.max((f - x) / 2, 0),
                            a = h.leftForLtr(t, m),
                            r = Be(i.borderRadius);
                        s.beginPath(), Object.values(r).some((t) => 0 !== t) ? ne(s, { x: a, y: o, w: m, h: x, radius: r }) : s.rect(a, o, m, x), s.fill(), 0 !== n && s.stroke();
                    }
                    s.restore();
                })(h.x(D), C, w),
        ...
        _getLegendItemAt(t, e) {
            ...
            if ($t(t, this.left, this.right) && $t(e, this.top, this.bottom))
                for (n = this.legendHitBoxes, i = 0; i < n.length; ++i) if (((s = n[i]), $t(t, s.left, s.left + s.width) && $t(e, s.top, s.top + s.height))) return this.legendItems[i];
            return null;
        }
        handleEvent(t) {
    ...
    class Do extends Ss {
        ...
        draw() {
            ...
            ie(t, e.text, 0, 0, i, { color: e.color, maxWidth: r, rotation: l, textAlign: s(e.align), textBaseline: "middle", translation: [o, a] });
        }
    }
    var Co = {
        id: "title",
    ...
    function Bo(t, e, i, s) {
        ...
        return (
            "center" === l ? ("left" === r ? (g += h) : "right" === r && (g -= h)) : "left" === r ? (g -= Math.max(c, u) + n) : "right" === r && (g += Math.max(d, f) + n),
    ...
    class Ho extends Ss {
        ...
        getContext() {
            return this.$context || (this.$context = ((t = this._chart.getContext()), (e = this), (i = this._tooltipItems), je(t, { tooltip: e, tooltipItems: i, type: "tooltip" })));
            var t, e, i;
        }
        getTitle(t, e) {
            const { callbacks: i } = e,
        ...
        drawBackground(t, e, i, s) {
            const { xAlign: n, yAlign: o } = this,
                { x: a, y: r } = t,
                { width: l, height: h } = i,
                { topLeft: c, topRight: d, bottomLeft: u, bottomRight: f } = Be(s.cornerRadius);
    ...
    var jo = {
        ...
        $o = Object.freeze({ __proto__: null, Decimation: oo, Filler: Mo, Legend: Po, SubTitle: Ao, Title: Co, Tooltip: jo });
    function Yo(t, e, i, s) {
        const n = t.indexOf(e);
    ...
    class qo extends zs {
        ...
        buildTicks() {
            ...
            const s = (function (t, e) {
                ...
                let P = 0;
                for (m && (d && v !== o ? (i.push({ value: o }), v < o && P++, Tt(Math.round((v + P * k) * y) / y, o, Xo(o, _, t)) && P++) : v < o && P++); P < M; ++P)
        ...
        buildTicks() {
            const t = this.options,
                e = (function (t, e) {
                    ...
                    do {
                        n.push({ value: o, major: Go(o) }), ++r, 10 === r && ((r = 1), ++a, (l = a >= 0 ? 1 : l)), (o = Math.round(r * Math.pow(10, a) * l) / l);
                    } while (a < i || (a === i && r < s));
                    const h = q(t.max, o);
    ...
    function ta(t) {
        ...
        for (let h = 0; h < o; h++) {
            ...
            const c = t.getPointPosition(h, t.drawingArea + n[h]),
                d = We(o.font),
                u = ((a = t.ctx), (r = d), (l = Y((l = t._pointLabels[h])) ? l : [l]), { w: Xt(a, r.string, l), h: l.length * r.lineHeight });
            s[h] = u;
                ...
                (e.pointLabels.display &&
                    (function (t, e) {
                        ...
                        for (let n = e - 1; n >= 0; n--) {
                            ...
                            ie(i, t._pointLabels[n], a, r + o.lineHeight / 2, o, { color: e.color, textAlign: l, textBaseline: "middle" });
                        }
                    })(this, n),
                s.display &&
    ...
    (aa.id = "radialLinear"),
        ...
        (aa.defaultRoutes = { "angleLines.color": "borderColor", "pointLabels.color": "color", "ticks.color": "color" }),
    ...
    function pa(t, e, i) {
        let s,
            ...
            l = t.length - 1;
        i
            ? (e >= t[r].pos && e <= t[l].pos && ({ lo: r, hi: l } = ae(t, "pos", e)), ({ pos: s, time: o } = t[r]), ({ pos: n, time: a } = t[l]))
            : (e >= t[r].time && e <= t[l].time && ({ lo: r, hi: l } = ae(t, "time", e)), ({ time: s, pos: o } = t[r]), ({ time: n, pos: a } = t[l]));
        const h = n - s;
    ...
    var xa = Object.freeze({ __proto__: null, CategoryScale: Uo, LinearScale: Ko, LogarithmicScale: Zo, RadialLinearScale: aa, TimeScale: ga, TimeSeriesScale: ma });
    return (
